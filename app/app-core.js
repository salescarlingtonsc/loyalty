...
const CUSTOMER_COPY=Object.freeze({
  en:Object.freeze({
    ...
    referralPendingTitleV777:'Referral reward',
    referralPendingBodyV777:'Spend {floor} in one visit and you get {points} extra points.',
    referralPendingBodyNoFloorV777:'Your {points} extra points arrive with your first purchase.',
    referralPendingFromV777:'Referred by {name}.',
    referralPendingBlockedV777:'This business has paused its points programme, so the referral reward is on hold until it is back on.',
    referralAppliedSheetTitleV777:'Referral applied',
    referralAppliedSheetNoteV777:'You can see this under Points & gifts until it is paid.',
    referralAppliedGotItV777:'Got it',
  ...
  'zh-CN':Object.freeze({
    ...
    referralPendingTitleV777:'推荐奖励',
    referralPendingBodyV777:'单次消费满 {floor}，即可额外获得 {points} 积分。',
    referralPendingBodyNoFloorV777:'首次消费后即可获得 {points} 额外积分。',
    referralPendingFromV777:'由 {name} 推荐。',
    referralPendingBlockedV777:'该商家已暂停积分计划，推荐奖励将在恢复后发放。',
    referralAppliedSheetTitleV777:'推荐已生效',
    referralAppliedSheetNoteV777:'在奖励发放前，你可以在“积分与礼品”中看到此奖励。',
    referralAppliedGotItV777:'知道了',
  ...
  ms:Object.freeze({
    ...
    referralPendingTitleV777:'Ganjaran rujukan',
    referralPendingBodyV777:'Belanja {floor} dalam satu lawatan dan anda dapat {points} mata tambahan.',
    referralPendingBodyNoFloorV777:'{points} mata tambahan anda tiba dengan pembelian pertama anda.',
    referralPendingFromV777:'Dirujuk oleh {name}.',
    referralPendingBlockedV777:'Perniagaan ini telah menjeda program matanya, jadi ganjaran rujukan ditangguhkan sehingga ia kembali aktif.',
    referralAppliedSheetTitleV777:'Rujukan digunakan',
    referralAppliedSheetNoteV777:'Anda boleh melihatnya di Mata & hadiah sehingga ia dibayar.',
    referralAppliedGotItV777:'Faham',
  ...
  ta:Object.freeze({
    ...
    referralPendingTitleV777:'பரிந்துரை வெகுமதி',
    referralPendingBodyV777:'ஒரே வருகையில் {floor} செலவழித்தால் கூடுதலாக {points} புள்ளிகள் கிடைக்கும்.',
    referralPendingBodyNoFloorV777:'உங்கள் முதல் வாங்குதலுடன் கூடுதல் {points} புள்ளிகள் கிடைக்கும்.',
    referralPendingFromV777:'{name} பரிந்துரைத்தார்.',
    referralPendingBlockedV777:'இந்த வணிகம் புள்ளித் திட்டத்தை இடைநிறுத்தியுள்ளது; அது மீண்டும் தொடங்கும் வரை பரிந்துரை வெகுமதி காத்திருக்கும்.',
    referralAppliedSheetTitleV777:'பரிந்துரை பயன்படுத்தப்பட்டது',
    referralAppliedSheetNoteV777:'அது வழங்கப்படும் வரை புள்ளிகள் & பரிசுகள் பகுதியில் இதைப் பார்க்கலாம்.',
    referralAppliedGotItV777:'சரி',
...
const WORKSPACE_TEMPLATE_COPY_V97=Object.freeze({
  ...
  saleReversalAmounts:Object.freeze({en:"{reversed} reversed · {refunded} refunded.",'zh-CN':"已撤销 {reversed} · 已退款 {refunded}。",ms:"{reversed} diterbalikkan · {refunded} dibayar balik."}),
  saleReversalAmountsReplayed:Object.freeze({en:"{reversed} reversed · {refunded} refunded · exact replay verified.",'zh-CN':"已撤销 {reversed} · 已退款 {refunded} · 已核实完全重演。",ms:"{reversed} diterbalikkan · {refunded} dibayar balik · main semula tepat disahkan."}),
  redemptionReversalAmounts:Object.freeze({en:"{points} points restored · {credit} credit compensated.",'zh-CN':"已恢复 {points} 积分 · 已补偿 {credit} 额度。",ms:"{points} mata dipulihkan · {credit} kredit diganti."}),
  redemptionReversalAmountsReplayed:Object.freeze({en:"{points} points restored · {credit} credit compensated · exact replay verified.",'zh-CN':"已恢复 {points} 积分 · 已补偿 {credit} 额度 · 已核实完全重演。",ms:"{points} mata dipulihkan · {credit} kredit diganti · main semula tepat disahkan."}),
  exactCompensationPointsCheck:Object.freeze({en:"{brand} checks the original points entry, every FEFO batch drain, the programme rules in effect at the time, and whether the {amount} reward credit may have been spent. If any proof is incomplete, it refuses the reversal.",'zh-CN':"{brand} 会核对原始积分记录、每一笔 FEFO 批次扣减、当时生效的方案规则，以及 {amount} 奖励额度是否可能已被使用。只要有任何一项凭证不完整，它就会拒绝这次撤销。",ms:"{brand} menyemak entri mata asal, setiap pengurangan kelompok FEFO, peraturan program yang berkuat kuasa pada masa itu, dan sama ada kredit ganjaran {amount} mungkin telah dibelanjakan. Jika mana-mana bukti tidak lengkap, ia menolak pembalikan itu."}),
  profileFiguresBranchListUnavailable:Object.freeze({en:"{modules} cannot be shown because the assigned-branch list could not be loaded. Peekaa does not replace missing data with zero.",'zh-CN':"{modules} 无法显示，因为无法载入已分配的分店清单。Peekaa 不会用零来代替缺失的数据。",ms:"{modules} tidak dapat ditunjukkan kerana senarai cawangan yang ditugaskan tidak dapat dimuatkan. Peekaa tidak menggantikan data yang hilang dengan sifar."}),
  profileFiguresAdminScopeUnconfirmed:Object.freeze({en:"{modules} cannot be shown because complete business-wide access could not be confirmed. Peekaa does not replace missing data with zero.",'zh-CN':"{modules} 无法显示，因为无法确认完整的全商户访问权限。Peekaa 不会用零来代替缺失的数据。",ms:"{modules} tidak dapat ditunjukkan kerana akses penuh seluruh perniagaan tidak dapat disahkan. Peekaa tidak menggantikan data yang hilang dengan sifar."}),
  profileFiguresStaffScopeUnconfirmed:Object.freeze({en:"{modules} cannot be shown because access across every branch assigned to this staff account could not be confirmed. Peekaa does not replace missing data with zero.",'zh-CN':"{modules} 无法显示，因为无法确认此员工账户在所有已分配分店的访问权限。Peekaa 不会用零来代替缺失的数据。",ms:"{modules} tidak dapat ditunjukkan kerana akses merentas setiap cawangan yang ditugaskan kepada akaun kakitangan ini tidak dapat disahkan. Peekaa tidak menggantikan data yang hilang dengan sifar."}),
  tierIsSetUpPausedReview:Object.freeze({en:"{count} tier is set up, but the programme Status above is Paused. Set Status to Active, then Review & publish — that is the whole fix.",'zh-CN':"已设置 {count} 个等级，但上方的方案状态是「已暂停」。请把状态设为「启用」，然后点「审核并发布」 — 这就是全部的修复步骤。",ms:"{count} peringkat telah disediakan, tetapi Status program di atas ialah Dijeda. Tetapkan Status kepada Aktif, kemudian Semak & terbitkan — itu sahaja penyelesaiannya."}),
  tierIsSetUpPausedSave:Object.freeze({en:"{count} tier is set up, but the programme Status above is Paused. Set Status to Active, then Save — that is the whole fix.",'zh-CN':"已设置 {count} 个等级，但上方的方案状态是「已暂停」。请把状态设为「启用」，然后点「保存」 — 这就是全部的修复步骤。",ms:"{count} peringkat telah disediakan, tetapi Status program di atas ialah Dijeda. Tetapkan Status kepada Aktif, kemudian Simpan — itu sahaja penyelesaiannya."}),
  tiersAreSetUpPausedReview:Object.freeze({en:"{count} tiers are set up, but the programme Status above is Paused. Set Status to Active, then Review & publish — that is the whole fix.",'zh-CN':"已设置 {count} 个等级，但上方的方案状态是「已暂停」。请把状态设为「启用」，然后点「审核并发布」 — 这就是全部的修复步骤。",ms:"{count} peringkat telah disediakan, tetapi Status program di atas ialah Dijeda. Tetapkan Status kepada Aktif, kemudian Semak & terbitkan — itu sahaja penyelesaiannya."}),
  tiersAreSetUpPausedSave:Object.freeze({en:"{count} tiers are set up, but the programme Status above is Paused. Set Status to Active, then Save — that is the whole fix.",'zh-CN':"已设置 {count} 个等级，但上方的方案状态是「已暂停」。请把状态设为「启用」，然后点「保存」 — 这就是全部的修复步骤。",ms:"{count} peringkat telah disediakan, tetapi Status program di atas ialah Dijeda. Tetapkan Status kepada Aktif, kemudian Simpan — itu sahaja penyelesaiannya."}),
  creditFullyUsedLeaves:Object.freeze({en:"If the {credit} credit is fully used, {product} leaves {profit} after product and reward cost.",'zh-CN':"如果 {credit} 的额度被全部用掉，{product} 在扣除产品成本和奖励成本后还剩 {profit}。",ms:"Jika kredit {credit} digunakan sepenuhnya, {product} meninggalkan {profit} selepas kos produk dan ganjaran."}),
  creditFullyUsedLeavesReview:Object.freeze({en:"If the {credit} credit is fully used, {product} leaves {profit} after product and reward cost; review this before saving.",'zh-CN':"如果 {credit} 的额度被全部用掉，{product} 在扣除产品成本和奖励成本后还剩 {profit}；保存前请再确认一下。",ms:"Jika kredit {credit} digunakan sepenuhnya, {product} meninggalkan {profit} selepas kos produk dan ganjaran; semak ini sebelum menyimpan."}),
  pricedItemTypicalSale:Object.freeze({en:"priced item. Your typical sale is",'zh-CN':"项有定价的商品。您的典型销售额是",ms:"item berharga. Jualan biasa anda ialah"}),
  pricedItemsTypicalSale:Object.freeze({en:"priced items. Your typical sale is",'zh-CN':"项有定价的商品。您的典型销售额是",ms:"item berharga. Jualan biasa anda ialah"}),
  visitInDaysReward:Object.freeze({en:"{visits} visit in {days} days → {reward}: {value}",'zh-CN':"{days} 天内到访 {visits} 次 → {reward}：{value}",ms:"{visits} lawatan dalam {days} hari → {reward}: {value}"}),
  visitsInDaysReward:Object.freeze({en:"{visits} visits in {days} days → {reward}: {value}",'zh-CN':"{days} 天内到访 {visits} 次 → {reward}：{value}",ms:"{visits} lawatan dalam {days} hari → {reward}: {value}"}),
  leaveBlankCustomersSee:Object.freeze({en:"Leave blank and customers see “{fallback}”",'zh-CN':"留空的话，顾客会看到「{fallback}」",ms:"Biarkan kosong dan pelanggan akan melihat “{fallback}”"}),
  liveOfferPageCountPickHome:Object.freeze({en:"live offer on your business page — {live} of {limit} live now. One of them also shows on their Home screen; pick which with",'zh-CN':"个上线优惠都会出现在您的商家页面上 — 目前 {limit} 个中有 {live} 个在线。其中一个还会显示在他们的首页；请用以下按钮选择：",ms:"tawaran langsung di halaman perniagaan anda — {live} daripada {limit} kini langsung. Satu daripadanya turut dipaparkan di skrin Utama mereka; pilih yang mana dengan"}),
  busiestOpenTimes:Object.freeze({en:"Busiest open times: {times}",'zh-CN':"最忙的营业时段：{times}",ms:"Waktu buka paling sibuk: {times}"}),
  busiestOpenTimesUnknown:Object.freeze({en:"Busiest open times: not enough data yet",'zh-CN':"最忙的营业时段：数据还不够",ms:"Waktu buka paling sibuk: data belum mencukupi"}),
  quietestOpenTimes:Object.freeze({en:"Quietest open times: {times}",'zh-CN':"最清闲的营业时段：{times}",ms:"Waktu buka paling lengang: {times}"}),
  quietestOpenTimesUnknown:Object.freeze({en:"Quietest open times: not enough data yet",'zh-CN':"最清闲的营业时段：数据还不够",ms:"Waktu buka paling lengang: data belum mencukupi"}),
  returnedOnTheirOwnNetRemoves:Object.freeze({en:"returned on their own ({rate}). The net figure above removes that share.",'zh-CN':"自行回头了（{rate}）。上方的净值已经扣除了这一部分。",ms:"kembali dengan sendirinya ({rate}). Angka bersih di atas menolak bahagian itu."}),
  returnedThenComparison:Object.freeze({en:"({returned} returned) · Comparison:",'zh-CN':"（{returned} 位回头） · 对照组：",ms:"({returned} kembali) · Perbandingan:"}),
  returnedCount:Object.freeze({en:"({returned} returned)",'zh-CN':"（{returned} 位回头）",ms:"({returned} kembali)"}),
  expenseRecordedOn:Object.freeze({en:"Recorded {date}. The date and the branch stay as they are — they decide which P&L this cost already sits in.",'zh-CN':"记录于 {date}。日期和分店保持不变 — 它们决定了这笔成本已经计入哪一份损益表。",ms:"Direkodkan {date}. Tarikh dan cawangan kekal seperti sedia ada — kedua-duanya menentukan Untung Rugi yang mana kos ini sudah berada di dalamnya."}),
  expenseRecordedOnOverhead:Object.freeze({en:"Recorded {date} as business-wide overhead. The date and the branch stay as they are — they decide which P&L this cost already sits in.",'zh-CN':"记录于 {date}，属于全商户的间接费用。日期和分店保持不变 — 它们决定了这笔成本已经计入哪一份损益表。",ms:"Direkodkan {date} sebagai overhed seluruh perniagaan. Tarikh dan cawangan kekal seperti sedia ada — kedua-duanya menentukan Untung Rugi yang mana kos ini sudah berada di dalamnya."}),
  expenseRecordedOnUnknownDate:Object.freeze({en:"Recorded on an unrecorded date. The date and the branch stay as they are — they decide which P&L this cost already sits in.",'zh-CN':"记录时未填日期。日期和分店保持不变 — 它们决定了这笔成本已经计入哪一份损益表。",ms:"Direkodkan pada tarikh yang tidak direkodkan. Tarikh dan cawangan kekal seperti sedia ada — kedua-duanya menentukan Untung Rugi yang mana kos ini sudah berada di dalamnya."}),
  expenseRecordedOnUnknownDateOverhead:Object.freeze({en:"Recorded on an unrecorded date as business-wide overhead. The date and the branch stay as they are — they decide which P&L this cost already sits in.",'zh-CN':"记录时未填日期，属于全商户的间接费用。日期和分店保持不变 — 它们决定了这笔成本已经计入哪一份损益表。",ms:"Direkodkan pada tarikh yang tidak direkodkan sebagai overhed seluruh perniagaan. Tarikh dan cawangan kekal seperti sedia ada — kedua-duanya menentukan Untung Rugi yang mana kos ini sudah berada di dalamnya."}),
  itemsTicked:Object.freeze({en:"{count} ticked.",'zh-CN':"已勾选 {count} 项。",ms:"{count} ditanda."}),
  nothingChangesYetThey:Object.freeze({en:"Nothing changes yet — everything they have collected stays saved, and you can come back at any time.",'zh-CN':"目前还不会有任何改动 — 他们已累积的一切都会保留，您随时可以回来继续。",ms:"Tiada apa-apa berubah lagi — segala yang mereka kumpulkan kekal tersimpan, dan anda boleh kembali bila-bila masa."}),
  nothingChangesYetIt:Object.freeze({en:"Nothing changes yet — everything it has collected stays saved, and you can come back at any time.",'zh-CN':"目前还不会有任何改动 — 它已累积的一切都会保留，您随时可以回来继续。",ms:"Tiada apa-apa berubah lagi — segala yang ia kumpulkan kekal tersimpan, dan anda boleh kembali bila-bila masa."}),
  stampGiftGivenBack:Object.freeze({en:"{claims} stamp gift given back",'zh-CN':"已退回 {claims} 份集章礼物",ms:"{claims} hadiah setem dipulangkan"}),
  stampGiftsGivenBack:Object.freeze({en:"{claims} stamp gifts given back",'zh-CN':"已退回 {claims} 份集章礼物",ms:"{claims} hadiah setem dipulangkan"}),
  stampCardOpenAgain:Object.freeze({en:"the customer's stamp card is open again",'zh-CN':"顾客的集章卡重新开启",ms:"kad setem pelanggan dibuka semula"}),
  creditCompensatedAmount:Object.freeze({en:"{credit} credit compensated",'zh-CN':"已补偿 {credit} 额度",ms:"{credit} kredit diganti"}),
  exactReplayVerified:Object.freeze({en:"exact replay verified",'zh-CN':"已核实完全重演",ms:"main semula tepat disahkan"}),
  exactCompensationClaimCheck:Object.freeze({en:"{brand} checks the original claim on the customer's card, the programme rules in effect at the time, and whether the {amount} reward credit may have been spent. If any proof is incomplete, it refuses the reversal. The claim is removed and the slot on the card comes back; nothing in the history is deleted.",'zh-CN':"{brand} 会核对顾客卡片上的原始领取记录、当时生效的方案规则，以及 {amount} 奖励额度是否可能已被使用。只要有任何一项凭证不完整，它就会拒绝这次撤销。领取记录会被移除，卡上的格子会回来；历史记录里的任何内容都不会被删除。",ms:"{brand} menyemak tuntutan asal pada kad pelanggan, peraturan program yang berkuat kuasa pada masa itu, dan sama ada kredit ganjaran {amount} mungkin telah dibelanjakan. Jika mana-mana bukti tidak lengkap, ia menolak pembalikan itu. Tuntutan itu dialih keluar dan slot pada kad kembali; tiada apa-apa dalam sejarah dipadamkan."}),
  todaysScheduleCouldNotLoad:Object.freeze({en:"Today’s schedule could not be loaded.",'zh-CN':"今天的排班无法载入。",ms:"Jadual hari ini tidak dapat dimuatkan."}),
  scheduleForDayCouldNotLoad:Object.freeze({en:"The schedule for {day} could not be loaded.",'zh-CN':"{day} 的排班无法载入。",ms:"Jadual untuk {day} tidak dapat dimuatkan."}),
  ledgerTotalPoints:Object.freeze({en:"Ledger total: {total} points.",'zh-CN':"账本总计：{total} 积分。",ms:"Jumlah lejar: {total} mata."}),
  ledgerTotalStamps:Object.freeze({en:"Ledger total: {total} stamps.",'zh-CN':"账本总计：{total} 个印章。",ms:"Jumlah lejar: {total} setem."}),
  ledgerTotalPointsRunning:Object.freeze({en:"Ledger total: {total} points in the running programme — movements in a paused or retired programme are not listed here.",'zh-CN':"账本总计：进行中方案的 {total} 积分 — 已暂停或已停用方案中的变动不会列在这里。",ms:"Jumlah lejar: {total} mata dalam program yang sedang berjalan — pergerakan dalam program yang dijeda atau ditamatkan tidak disenaraikan di sini."}),
  ledgerTotalStampsRunning:Object.freeze({en:"Ledger total: {total} stamps in the running programme — movements in a paused or retired programme are not listed here.",'zh-CN':"账本总计：进行中方案的 {total} 个印章 — 已暂停或已停用方案中的变动不会列在这里。",ms:"Jumlah lejar: {total} setem dalam program yang sedang berjalan — pergerakan dalam program yang dijeda atau ditamatkan tidak disenaraikan di sini."}),
  birthdayBenefitLiveWindow:Object.freeze({en:"{benefit} · Live for eligible customers · window {before} day(s) before to {after} day(s) after",'zh-CN':"{benefit} · 对符合条件的顾客已上线 · 生日前 {before} 天到生日后 {after} 天的窗口",ms:"{benefit} · Langsung untuk pelanggan yang layak · tetingkap {before} hari sebelum hingga {after} hari selepas"}),
  birthdayBenefitPausedWindow:Object.freeze({en:"{benefit} · Published but paused · window {before} day(s) before to {after} day(s) after",'zh-CN':"{benefit} · 已发布但已暂停 · 生日前 {before} 天到生日后 {after} 天的窗口",ms:"{benefit} · Diterbitkan tetapi dijeda · tetingkap {before} hari sebelum hingga {after} hari selepas"}),
  atLivePublishLimit:Object.freeze({en:"You are at the limit — move one back to draft before publishing another.",'zh-CN':"您已达上限 — 请先把其中一个改回草稿，再发布下一个。",ms:"Anda telah mencapai had — alihkan satu kembali ke draf sebelum menerbitkan yang lain."}),
  youCanPublishMore:Object.freeze({en:"You can publish {count} more.",'zh-CN':"您还可以再发布 {count} 个。",ms:"Anda boleh menerbitkan {count} lagi."}),
  complimentaryPublishingEnds:Object.freeze({en:"Complimentary first-time publishing ends {date}.",'zh-CN':"首次免费发布将于 {date} 结束。",ms:"Penerbitan kali pertama percuma tamat pada {date}."}),
  availableOnlyAtBranch:Object.freeze({en:"Available only at {branch}.",'zh-CN':"仅在 {branch} 提供。",ms:"Tersedia hanya di {branch}."}),
  availableOnlyAtCurrentBranch:Object.freeze({en:"Available only at the current branch.",'zh-CN':"仅在当前分店提供。",ms:"Tersedia hanya di cawangan semasa."}),
  oneGiftPastCardEnd:Object.freeze({en:"Your card is {target} stamps long, but a gift sits past the end of it — at stamp {stamp}. Customers finish the card before they reach it, so the counter will refuse it. Make the card longer, or move that gift onto a stamp inside the card — tap one to edit it.",'zh-CN':"您的卡片共 {target} 个印章，但有一份礼物落在卡片末尾之外 — 在第 {stamp} 个印章上。顾客在够到它之前就已经集满整张卡，所以柜台会拒绝兑换。请把卡片加长，或把那份礼物移到卡片之内的某个印章上 — 点一下即可编辑。",ms:"Kad anda sepanjang {target} setem, tetapi satu hadiah berada melepasi hujungnya — pada setem {stamp}. Pelanggan menghabiskan kad sebelum sampai kepadanya, jadi kaunter akan menolaknya. Panjangkan kad itu, atau alihkan hadiah itu ke setem di dalam kad — ketik satu untuk menyuntingnya."}),
  giftsPastCardEnd:Object.freeze({en:"Your card is {target} stamps long, but {count} gifts sit past the end of it. Customers finish the card before they reach them, so the counter will refuse them. Make the card longer, or move those gifts onto a stamp inside the card — tap one to edit it.",'zh-CN':"您的卡片共 {target} 个印章，但有 {count} 份礼物落在卡片末尾之外。顾客在够到它们之前就已经集满整张卡，所以柜台会拒绝兑换。请把卡片加长，或把那些礼物移到卡片之内的印章上 — 点一下即可编辑。",ms:"Kad anda sepanjang {target} setem, tetapi {count} hadiah berada melepasi hujungnya. Pelanggan menghabiskan kad sebelum sampai kepadanya, jadi kaunter akan menolaknya. Panjangkan kad itu, atau alihkan hadiah itu ke setem di dalam kad — ketik satu untuk menyuntingnya."}),
  reachedAtThreshold:Object.freeze({en:"Reached at {threshold}",'zh-CN':"达到 {threshold} 即可进入",ms:"Dicapai pada {threshold}"}),
  reachedAtThresholdMultiplier:Object.freeze({en:"Reached at {threshold} · {multiplier}× points",'zh-CN':"达到 {threshold} 即可进入 · {multiplier} 倍积分",ms:"Dicapai pada {threshold} · {multiplier}× mata"}),
  couldNotBePrepared:Object.freeze({en:"{count} could not be prepared: {names}.",'zh-CN':"有 {count} 项无法准备：{names}。",ms:"{count} tidak dapat disediakan: {names}."}),
  couldNotBePreparedAndMore:Object.freeze({en:"{count} could not be prepared: {names} and {more} more.",'zh-CN':"有 {count} 项无法准备：{names}，另有 {more} 项。",ms:"{count} tidak dapat disediakan: {names} dan {more} lagi."}),
  pauseReasonWas:Object.freeze({en:"Reason: {reason}.",'zh-CN':"原因：{reason}。",ms:"Sebab: {reason}."}),
  pausedByActor:Object.freeze({en:"By {actor}.",'zh-CN':"操作者：{actor}。",ms:"Oleh {actor}."}),
  pausedAtServerTime:Object.freeze({en:"At {at} (server time).",'zh-CN':"时间：{at}（服务器时间）。",ms:"Pada {at} (waktu pelayan)."}),
  paidValueExpiryNone:Object.freeze({en:"Paid value expiry: no expiry",'zh-CN':"已付金额有效期：永不过期",ms:"Luput nilai berbayar: tiada luput"}),
  paidValueExpiryDay:Object.freeze({en:"Paid value expiry: {days} day",'zh-CN':"已付金额有效期：{days} 天",ms:"Luput nilai berbayar: {days} hari"}),
  paidValueExpiryDays:Object.freeze({en:"Paid value expiry: {days} days",'zh-CN':"已付金额有效期：{days} 天",ms:"Luput nilai berbayar: {days} hari"}),
  bonusExpiryNone:Object.freeze({en:"bonus expiry: no expiry",'zh-CN':"赠送金额有效期：永不过期",ms:"luput bonus: tiada luput"}),
  bonusExpiryDay:Object.freeze({en:"bonus expiry: {days} day",'zh-CN':"赠送金额有效期：{days} 天",ms:"luput bonus: {days} hari"}),
  bonusExpiryDays:Object.freeze({en:"bonus expiry: {days} days",'zh-CN':"赠送金额有效期：{days} 天",ms:"luput bonus: {days} hari"}),
  iConfirmCustomerPaid:Object.freeze({en:"I confirm the customer has paid.",'zh-CN':"我确认顾客已付款。",ms:"Saya mengesahkan pelanggan telah membayar."}),
  iConfirmCustomerPaidAmount:Object.freeze({en:"I confirm the customer has paid {amount}.",'zh-CN':"我确认顾客已支付 {amount}。",ms:"Saya mengesahkan pelanggan telah membayar {amount}."}),
  collectingIssuing:Object.freeze({en:"You are collecting {collecting} and issuing {issuing} paid value.",'zh-CN':"您将收取 {collecting}，并发出 {issuing} 的已付金额。",ms:"Anda mengutip {collecting} dan mengeluarkan nilai berbayar {issuing}."}),
  collectingIssuingWithBonus:Object.freeze({en:"You are collecting {collecting} and issuing {issuing} paid value plus {bonus} promotional bonus.",'zh-CN':"您将收取 {collecting}，并发出 {issuing} 的已付金额，外加 {bonus} 的促销赠额。",ms:"Anda mengutip {collecting} dan mengeluarkan nilai berbayar {issuing} serta bonus promosi {bonus}."}),
  dayBlocked:Object.freeze({en:"{count} day blocked.",'zh-CN':"已封锁 {count} 天。",ms:"{count} hari disekat."}),
  daysBlocked:Object.freeze({en:"{count} days blocked.",'zh-CN':"已封锁 {count} 天。",ms:"{count} hari disekat."}),
  dayCouldNotBeBlocked:Object.freeze({en:"{count} day could not be blocked: {days}",'zh-CN':"有 {count} 天无法封锁：{days}",ms:"{count} hari tidak dapat disekat: {days}"}),
  daysCouldNotBeBlocked:Object.freeze({en:"{count} days could not be blocked: {days}",'zh-CN':"有 {count} 天无法封锁：{days}",ms:"{count} hari tidak dapat disekat: {days}"}),
  sessionsLeftBought:Object.freeze({en:"{remaining} of {sessions} left · bought {bought}",'zh-CN':"剩余 {remaining}／共 {sessions} 次 · 购买于 {bought}",ms:"{remaining} daripada {sessions} berbaki · dibeli {bought}"}),
  sessionsLeftBoughtUseBy:Object.freeze({en:"{remaining} of {sessions} left · bought {bought} · use by {useBy}",'zh-CN':"剩余 {remaining}／共 {sessions} 次 · 购买于 {bought} · 请在 {useBy} 前使用",ms:"{remaining} daripada {sessions} berbaki · dibeli {bought} · guna sebelum {useBy}"}),
  recordSaleAddsGst:Object.freeze({en:"When on, Record sale adds {rate}% GST on top of your listed prices at this branch.",'zh-CN':"开启后，本分店的「记录销售」会在您的标价之上加收 {rate}% 消费税。",ms:"Apabila dihidupkan, Rekod jualan menambah GST {rate}% di atas harga tersenarai anda di cawangan ini."}),
  oneBranchAwaitingPayment:Object.freeze({en:"One branch is saved but switched off until payment confirms. Nothing at it can take a booking or a sale yet.",'zh-CN':"有 1 家分店已保存，但在付款确认前处于关闭状态。该分店目前还无法接受预订或销售。",ms:"Satu cawangan disimpan tetapi dimatikan sehingga pembayaran disahkan. Belum ada apa-apa di situ yang boleh menerima tempahan atau jualan."}),
  branchesAwaitingPayment:Object.freeze({en:"{count} branches are saved but switched off until payment confirms. Nothing at them can take a booking or a sale yet.",'zh-CN':"有 {count} 家分店已保存，但在付款确认前处于关闭状态。这些分店目前还无法接受预订或销售。",ms:"{count} cawangan disimpan tetapi dimatikan sehingga pembayaran disahkan. Belum ada apa-apa di situ yang boleh menerima tempahan atau jualan."}),
  medianVsMean:Object.freeze({en:"— median {median} vs mean {mean} per customer",'zh-CN':"— 每位顾客中位数 {median}，平均数 {mean}",ms:"— median {median} berbanding min {mean} setiap pelanggan"}),
  medianVsMeanTopCustomer:Object.freeze({en:"— median {median} vs mean {mean} per customer · top customer carries {top}%",'zh-CN':"— 每位顾客中位数 {median}，平均数 {mean} · 最大顾客占 {top}%",ms:"— median {median} berbanding min {mean} setiap pelanggan · pelanggan teratas menyumbang {top}%"}),
  categoryViewCovers:Object.freeze({en:"Category view covers {covered}% of service & retail revenue.",'zh-CN':"分类视图涵盖了服务与零售营收的 {covered}%。",ms:"Paparan kategori meliputi {covered}% daripada hasil perkhidmatan & runcit."}),
  categoryViewCoversProjected:Object.freeze({en:"Category view covers {covered}% of service & retail revenue. {projected}% projected through current mappings, not snapshots.",'zh-CN':"分类视图涵盖了服务与零售营收的 {covered}%。其中 {projected}% 是按当前映射推算的，并非快照数据。",ms:"Paparan kategori meliputi {covered}% daripada hasil perkhidmatan & runcit. {projected}% diunjurkan melalui pemetaan semasa, bukan syot kilat."}),
  lastSaleWas:Object.freeze({en:"Data may be out of date — last sale {date}.",'zh-CN':"数据可能不是最新的 — 最近一笔销售在 {date}。",ms:"Data mungkin tidak terkini — jualan terakhir {date}."}),
  lastSaleNeverRecorded:Object.freeze({en:"Data may be out of date — no sale has ever been recorded.",'zh-CN':"数据可能不是最新的 — 从未记录过任何销售。",ms:"Data mungkin tidak terkini — tiada jualan pernah direkodkan."}),
  identityCoverage:Object.freeze({en:"Identity coverage: {identified} of {eligible} eligible recorded purchases.",'zh-CN':"身份覆盖率：已记录的合格消费中有 {identified} 笔（共 {eligible} 笔）识别到顾客。",ms:"Liputan identiti: {identified} daripada {eligible} pembelian layak yang direkodkan."}),
  identityCoveragePct:Object.freeze({en:"Identity coverage: {identified} of {eligible} eligible recorded purchases ({share}).",'zh-CN':"身份覆盖率：已记录的合格消费中有 {identified} 笔（共 {eligible} 笔）识别到顾客（{share}）。",ms:"Liputan identiti: {identified} daripada {eligible} pembelian layak yang direkodkan ({share})."}),
  codeStillWorks:Object.freeze({en:"This is the code you already created — it still works.",'zh-CN':"这就是您之前创建的代码 — 它仍然有效。",ms:"Ini kod yang anda sudah cipta — ia masih berfungsi."}),
  codeStillWorksUntil:Object.freeze({en:"This is the code you already created — it still works, until {until}.",'zh-CN':"这就是您之前创建的代码 — 在 {until} 之前仍然有效。",ms:"Ini kod yang anda sudah cipta — ia masih berfungsi sehingga {until}."}),
  requiredDependenciesAddedAsRead:Object.freeze({en:"Required dependencies added as Read: {modules}.",'zh-CN':"已按「只读」加入必需的依赖模块：{modules}。",ms:"Kebergantungan yang diperlukan ditambah sebagai Baca: {modules}."}),
  skippedUnavailableModules:Object.freeze({en:"Skipped unavailable modules: {modules}.",'zh-CN':"已跳过不可用的模块：{modules}。",ms:"Modul yang tidak tersedia dilangkau: {modules}."}),
  leaveBlankAndShown:Object.freeze({en:"Leave it blank and “{fallback}” is shown.",'zh-CN':"留空的话，会显示「{fallback}」。",ms:"Biarkan kosong dan “{fallback}” akan dipaparkan."}),
  leaveBlankNoLineShown:Object.freeze({en:"Leave it blank and no line is shown.",'zh-CN':"留空的话，不会显示任何文字。",ms:"Biarkan kosong dan tiada baris dipaparkan."}),
  upToPhotos:Object.freeze({en:"— up to {max} photos",'zh-CN':"— 最多 {max} 张照片",ms:"— sehingga {max} foto"}),
  upToPhotosAdded:Object.freeze({en:"— up to {max} photos · {added} added",'zh-CN':"— 最多 {max} 张照片 · 已添加 {added} 张",ms:"— sehingga {max} foto · {added} ditambah"}),
  topSellerByRevenueMarginUnknown:Object.freeze({en:"Top seller by revenue: {itemName} ({amount}). Margin is unknown — no item in your catalogue has a cost price set yet.",'zh-CN':"收入最高的商品：{itemName}（{amount}）。利润未知 — 您的目录里还没有任何商品设定成本价。",ms:"Item paling banyak hasil: {itemName} ({amount}). Margin tidak diketahui — belum ada item dalam katalog anda yang mempunyai harga kos."}),
  topSellerByRevenueAndByMargin:Object.freeze({en:"Top seller by revenue: {itemName} ({amount}). Top by margin: {marginItemName} ({marginAmount}).",'zh-CN':"收入最高的商品：{itemName}（{amount}）。利润最高的商品：{marginItemName}（{marginAmount}）。",ms:"Item paling banyak hasil: {itemName} ({amount}). Item paling banyak margin: {marginItemName} ({marginAmount})."}),
  mostBoughtTogetherPair:Object.freeze({en:"Most bought together: {itemA} and {itemB} ({attachPct}% attach rate).",'zh-CN':"最常一起购买：{itemA} 和 {itemB}（搭配率 {attachPct}%）。",ms:"Paling kerap dibeli bersama: {itemA} dan {itemB} (kadar gandingan {attachPct}%)."}),
  discountsGivenButNoStaffAttributed:Object.freeze({en:"{amount} in discounts were given, but none of it could be attributed to a staff member.",'zh-CN':"已给出 {amount} 的折扣，但无法算到任何一位员工身上。",ms:"Diskaun sebanyak {amount} telah diberi, tetapi tiada satu pun dapat dikaitkan dengan mana-mana kakitangan."}),
  noneOfYourIdentifiedCustomersVisitMoreThanOneOutlet:Object.freeze({en:"None of your {total} identified customers visit more than one outlet yet.",'zh-CN':"您已识别的 {total} 位顾客中，还没有人到访过一家以上的门店。",ms:"Daripada {total} pelanggan anda yang dikenal pasti, belum ada yang mengunjungi lebih daripada satu cawangan."}),
  identifiedCustomersVisitingMoreThanOneOutlet:Object.freeze({en:"{count} of {total} identified customers ({sharePct}%) visit more than one outlet.",'zh-CN':"已识别的 {total} 位顾客中有 {count} 位（{sharePct}%）到访过一家以上的门店。",ms:"{count} daripada {total} pelanggan yang dikenal pasti ({sharePct}%) mengunjungi lebih daripada satu cawangan."}),
  pointsEarnedInLast90DaysNoneExpired:Object.freeze({en:"{earned} points earned in the last 90 days; none have expired yet.",'zh-CN':"过去 90 天赚取 {earned} 积分；还没有任何积分过期。",ms:"{earned} mata diperoleh dalam 90 hari lepas; belum ada yang luput."}),
  pointsEarnedInLast90DaysExpiredUnused:Object.freeze({en:"{expired} of {earned} points earned in the last 90 days expired unused ({pct}%).",'zh-CN':"过去 90 天赚取的 {earned} 积分中，有 {expired} 积分没用就过期了（{pct}%）。",ms:"{expired} daripada {earned} mata yang diperoleh dalam 90 hari lepas luput tanpa digunakan ({pct}%)."}),
  membersVisitDaysVersusNonMembers:Object.freeze({en:"Members visit {memberDays} days on average versus {nonMemberDays} for non-members.",'zh-CN':"会员平均到访 {memberDays} 天，非会员是 {nonMemberDays} 天。",ms:"Ahli datang {memberDays} hari secara purata berbanding {nonMemberDays} hari bagi bukan ahli."}),
  staffRosteredHoursWithZeroSalesClause:Object.freeze({en:"; {staff} is rostered {hours} hours with 0 sales in the window.",'zh-CN':"；{staff} 排班 {hours} 小时，期间没有任何销售。",ms:"; {staff} dijadualkan bekerja {hours} jam tanpa jualan dalam tempoh ini."}),
  andStaffRosteredHoursWithZeroSalesClause:Object.freeze({en:", and {staff} is rostered {hours} hours with 0 sales in the window.",'zh-CN':"，{staff} 排班 {hours} 小时，期间没有任何销售。",ms:", dan {staff} dijadualkan bekerja {hours} jam tanpa jualan dalam tempoh ini."}),
  staffRosteredHoursButNoAttributedSales:Object.freeze({en:"{staff} is rostered {hours} hours but has 0 attributed sales in the window.",'zh-CN':"{staff} 排班 {hours} 小时，但期间没有销售算在名下。",ms:"{staff} dijadualkan bekerja {hours} jam tetapi tiada jualan direkod atas namanya dalam tempoh ini."}),
  thisRewardExpiredOn:Object.freeze({en:"This reward expired on {expiryDate}.",'zh-CN':"此奖励已于 {expiryDate} 过期。",ms:"Ganjaran ini tamat tempoh pada {expiryDate}."}),
  somethingWentWrongNothingRedeemedQuoteReference:Object.freeze({en:"Something went wrong on our side, so nothing was redeemed. Try again — if it keeps happening, quote reference {referenceCode} to Peekaa support.",'zh-CN':"我们这边出了点问题，所以没有兑换任何东西。请再试一次 — 如果一直如此，请把参考代码 {referenceCode} 告诉 Peekaa 客服。",ms:"Ada masalah di pihak kami, jadi tiada apa-apa ditebus. Cuba lagi — jika ia terus berlaku, beritahu kod rujukan {referenceCode} kepada sokongan Peekaa."}),
  thisGiftNeedsAtLeastOnTheSale:Object.freeze({en:"This gift needs at least {minimumSpend} on the sale.",'zh-CN':"此礼物需要该笔销售至少 {minimumSpend}。",ms:"Hadiah ini memerlukan sekurang-kurangnya {minimumSpend} pada jualan itu."}),
  scanningIsPausedForThisCode:Object.freeze({en:"{statusMessage} Scanning is paused for this code — show a different QR, or press “Confirm redemption” under “Camera unavailable?” to send this one again.",'zh-CN':"{statusMessage} 此代码的扫描已暂停 — 请出示另一个二维码，或在「摄像头不可用？」下按「确认兑换」再发送一次。",ms:"{statusMessage} Pengimbasan dijeda untuk kod ini — tunjukkan QR lain, atau tekan “Sahkan penebusan” di bawah “Kamera tidak tersedia?” untuk menghantarnya sekali lagi."}),
  chooseARangeOfDaysOrFewer:Object.freeze({en:"Choose a range of {maxDays} days or fewer.",'zh-CN':"请选择 {maxDays} 天或更少的时间范围。",ms:"Pilih julat {maxDays} hari atau kurang."}),
  salesAreLevelAndSoIsTheAverageSale:Object.freeze({en:"Sales are level ({saleCount} each) and so is the average sale ({averageSale}).",'zh-CN':"销售笔数持平（每人 {saleCount} 笔），每单平均金额也持平（{averageSale}）。",ms:"Jualan adalah sama ({saleCount} setiap seorang) dan purata setiap jualan juga sama ({averageSale})."}),
  salesAreLevelBiggestAverageSaleIs:Object.freeze({en:"Sales are level ({saleCount} each); {staffName} has the biggest average sale ({averageSale}).",'zh-CN':"销售笔数持平（每人 {saleCount} 笔）；{staffName} 的每单平均金额最高（{averageSale}）。",ms:"Jualan adalah sama ({saleCount} setiap seorang); {staffName} mempunyai purata setiap jualan tertinggi ({averageSale})."}),
  closesTheMostSalesAverageSaleIsLevel:Object.freeze({en:"{staffName} closes the most sales ({saleCount}); the average sale is level ({averageSale}).",'zh-CN':"{staffName} 成交的销售最多（{saleCount} 笔）；每单平均金额持平（{averageSale}）。",ms:"{staffName} menutup jualan paling banyak ({saleCount}); purata setiap jualan adalah sama ({averageSale})."}),
  leadsOnBothMostSalesAndBiggestAverageSale:Object.freeze({en:"{staffName} leads on both: the most sales ({saleCount}) and the biggest average sale ({averageSale}).",'zh-CN':"{staffName} 两项都领先：销售笔数最多（{saleCount} 笔），每单平均金额也最高（{averageSale}）。",ms:"{staffName} mendahului kedua-duanya: jualan paling banyak ({saleCount}) dan purata setiap jualan tertinggi ({averageSale})."}),
  nothingBookedOnDaySummary:Object.freeze({en:"Nothing booked on {day}.",'zh-CN':"{day} 没有任何预约。",ms:"Tiada apa ditempah pada {day}."}),
  costUpToAmount:Object.freeze({en:"Cost up to {amount}.",'zh-CN':"费用最多 {amount}。",ms:"Kos sehingga {amount}."}),
  onPaceForAmountThisMonth:Object.freeze({en:"On pace for {amount} this month.",'zh-CN':"照这个速度，本月预计 {amount}。",ms:"Pada kadar ini, bulan ini akan mencapai {amount}."}),
  holdsMoreThanOnePackageUsesListedByName:Object.freeze({en:"This customer holds more than one “{packageName}”. A session use is recorded on the sale, not against one purchase, so the list below covers every use of this package name since this one was bought.",'zh-CN':"这位顾客持有不止一份“{packageName}”。次数的使用记在那笔销售上，不是记在某一次购买上，所以下面的列表列出这一份买下之后，这个配套名称的每一次使用。",ms:"Pelanggan ini ada lebih daripada satu “{packageName}”. Penggunaan sesi direkodkan pada jualan itu, bukan pada satu pembelian, jadi senarai di bawah merangkumi setiap penggunaan nama pakej ini sejak yang ini dibeli."}),
  giveRewardNowNoPurchaseNeeded:Object.freeze({en:"Give \"{rewardName}\" to {customerName} now? This reward needs no purchase, so confirming hands it over and uses it up.",'zh-CN':"现在把“{rewardName}”给{customerName}吗？这份奖励不需要消费，所以一确认就等于交给顾客并用掉了。",ms:"Beri \"{rewardName}\" kepada {customerName} sekarang? Ganjaran ini tidak perlu pembelian, jadi mengesahkannya bermakna ia diserahkan dan terus digunakan."}),
  soldPointsEarnedAndTotal:Object.freeze({en:"Sold · {pointsEarned} points earned · {pointsTotal} total",'zh-CN':"已售出 · 获得 {pointsEarned} 积分 · 合计 {pointsTotal}",ms:"Dijual · {pointsEarned} mata diperoleh · jumlah {pointsTotal}"}),
  compensatingReversalRowAuditId:Object.freeze({en:"Compensating reversal row. Audit record id of the sale it reverses: {reversedSaleId}",'zh-CN':"这是一条冲销记录，用来抵销原本那笔销售。被冲销那笔销售的审计记录编号：{reversedSaleId}",ms:"Baris pembalikan yang mengimbangi jualan asal. Id rekod audit bagi jualan yang dibalikkannya: {reversedSaleId}"}),
  replacementSaleRowCorrectsEarlierAmountAuditId:Object.freeze({en:"Replacement sale row, written to correct an earlier amount. Audit record id of the sale it corrects: {correctedSaleId}",'zh-CN':"这是替代的销售记录，用来更正之前的金额。被更正那笔销售的审计记录编号：{correctedSaleId}",ms:"Baris jualan gantian, ditulis untuk membetulkan jumlah yang lebih awal. Id rekod audit bagi jualan yang dibetulkannya: {correctedSaleId}"}),
  originalSaleRowLaterCorrectedAuditId:Object.freeze({en:"Original sale row, later corrected. Audit record id of the correction: {correctionSaleId}",'zh-CN':"这是原来的销售记录，后来被更正。更正记录的审计记录编号：{correctionSaleId}",ms:"Baris jualan asal, yang kemudiannya dibetulkan. Id rekod audit bagi pembetulan itu: {correctionSaleId}"}),
  originalSaleRowFullyReversedAuditId:Object.freeze({en:"Original sale row, fully reversed. Audit record id of the reversal: {reversalSaleId}",'zh-CN':"这是原来的销售记录，已经全额冲销。冲销记录的审计记录编号：{reversalSaleId}",ms:"Baris jualan asal, dibalikkan sepenuhnya. Id rekod audit bagi pembalikan itu: {reversalSaleId}"}),
  switchServiceOffConfirm:Object.freeze({en:"Switch \"{serviceName}\" off? Customers can no longer book it and staff can no longer sell it. Past bookings and sales keep it, and you can switch it back on at any time.",'zh-CN':"要关闭“{serviceName}”吗？顾客不能再预约，员工也不能再售卖。过去的预约和销售仍然保留它，您随时可以再开启。",ms:"Matikan \"{serviceName}\"? Pelanggan tidak boleh tempah lagi dan staf tidak boleh jual lagi. Tempahan dan jualan lepas masih mengekalkannya, dan anda boleh hidupkannya semula pada bila-bila masa."}),
  customersMissingMarketingConsentOrEligibilityEvidence:Object.freeze({en:"{missingCount} customers are missing recorded marketing consent or eligibility evidence.",'zh-CN':"有 {missingCount} 位顾客没有记录营销同意或资格依据。",ms:"{missingCount} pelanggan tiada rekod persetujuan pemasaran atau bukti kelayakan."}),
  pointsForEverySgd1Spent:Object.freeze({en:"{pointsPerDollar} points for every SGD 1 spent",'zh-CN':"每消费 1 新元可得 {pointsPerDollar} 积分",ms:"{pointsPerDollar} mata bagi setiap SGD 1 dibelanjakan"}),
  useOnePackageSessionForCustomerConfirm:Object.freeze({en:"Use one {planName} session for {customerName}? {remainingAfter} of {totalSessions} will be left. No payment is taken, and only Packages can undo it.",'zh-CN':"为 {customerName} 使用一次「{planName}」配套？{totalSessions} 次中还剩 {remainingAfter} 次。不收取任何款项，只有「配套」可以撤销。",ms:"Guna satu sesi {planName} untuk {customerName}? {remainingAfter} daripada {totalSessions} akan berbaki. Tiada bayaran diambil, dan hanya Pakej boleh membuat asalnya."}),
  saleEarnedPointsOnTotalLinesAreShares:Object.freeze({en:"This sale earned {pointsEarned} points on its total of {saleTotal}. Points are recorded once for the whole sale, so the figures above are each line's share of that, not separately recorded amounts.",'zh-CN':"这笔交易按 {saleTotal} 的总额赚取了 {pointsEarned} 积分。积分按整笔交易记录一次，因此上面每一行的数字只是这笔积分的分摊，并非单独记录的数额。",ms:"Jualan ini memperoleh {pointsEarned} mata atas jumlahnya {saleTotal}. Mata direkodkan sekali untuk keseluruhan jualan, jadi angka di atas ialah bahagian setiap baris daripada mata itu, bukan jumlah yang direkodkan secara berasingan."}),
  unlockAtAmountSpent:Object.freeze({en:"Unlock at {amount} spent",'zh-CN':"消费满 {amount} 解锁",ms:"Buka kunci apabila berbelanja {amount}"}),
  rewardStopsBeingOfferedToCustomers:Object.freeze({en:"“{rewardName}” stops being offered to customers.",'zh-CN':"“{rewardName}”将不再提供给顾客。",ms:"“{rewardName}” berhenti ditawarkan kepada pelanggan."}),
  itemNoLongerOnSaleChooseAnother:Object.freeze({en:"{itemName} is no longer on sale, so no new customer can be given it. Choose another item.",'zh-CN':"{itemName}已停售，无法再送给新顾客。请改选其他项目。",ms:"{itemName} tidak lagi dijual, jadi tiada pelanggan baharu boleh diberikannya. Pilih item lain."}),
  newSignUpsGetItemFreeAfterMinimumSpend:Object.freeze({en:"New sign-ups get {itemName} free once they spend {minSpend}.",'zh-CN':"新注册顾客消费满 {minSpend} 即可免费获得{itemName}。",ms:"Pendaftar baharu mendapat {itemName} percuma sebaik mereka berbelanja {minSpend}."}),
  newSignUpsGetItemFreeNoMinimumSpend:Object.freeze({en:"New sign-ups get {itemName} free — no minimum spend.",'zh-CN':"新注册顾客可免费获得{itemName} — 无最低消费。",ms:"Pendaftaran baharu mendapat {itemName} percuma — tiada perbelanjaan minimum."}),
  earnOneStampPerSgdSpent:Object.freeze({en:"Earn 1 stamp per SGD {spendAmount} spent",'zh-CN':"每消费 {spendAmount} 新元可得 1 个印花",ms:"Dapat 1 setem bagi setiap SGD {spendAmount} dibelanjakan"}),
  earnPointsPerSgdOneSpent:Object.freeze({en:"Earn {pointsRate} points per SGD 1 spent",'zh-CN':"每消费 1 新元可得 {pointsRate} 积分",ms:"Dapat {pointsRate} mata bagi setiap SGD 1 dibelanjakan"}),
  thatPhotoIsMbTheLimitIsTenMbChooseSmaller:Object.freeze({en:"That photo is {sizeMb} MB. The limit is 10 MB — choose a smaller photo.",'zh-CN':"这张照片有 {sizeMb} MB。上限是 10 MB — 请选一张小一点的照片。",ms:"Foto itu {sizeMb} MB. Hadnya 10 MB — pilih foto yang lebih kecil."}),
  liveNowEndsDate:Object.freeze({en:"Live now · ends {endDate}",'zh-CN':"进行中 · {endDate} 结束",ms:"Aktif sekarang · tamat {endDate}"}),
  publishedButCustomersCannotSeeItYetItStarts:Object.freeze({en:"Published, but customers cannot see it yet — it starts {startDate}.",'zh-CN':"已发布，但顾客还看不到 — 要到 {startDate} 才开始。",ms:"Diterbitkan, tetapi pelanggan belum boleh melihatnya — ia bermula pada {startDate}."}),
  endOfferCustomersStopSeeingItRecordKept:Object.freeze({en:"End \"{offerName}\"? Customers stop seeing it immediately. The record is kept so your reports stay accurate.",'zh-CN':"要结束「{offerName}」吗？顾客会立刻看不到它。记录会保留，让您的报告保持准确。",ms:"Tamatkan \"{offerName}\"? Pelanggan berhenti melihatnya serta-merta. Rekod itu disimpan supaya laporan anda kekal tepat."}),
  deleteDraftCannotBeUndoneNoCustomerHasSeenIt:Object.freeze({en:"Delete the draft \"{offerName}\"? This cannot be undone. No customer has seen it.",'zh-CN':"要删除草稿「{offerName}」吗？此操作无法撤销。还没有顾客看过它。",ms:"Padam draf \"{offerName}\"? Ini tidak boleh dibatalkan. Tiada pelanggan pernah melihatnya."}),
  photoWasNotSavedYourWordsAreSafePressSaveDraft:Object.freeze({en:"Photo was not saved: {errorMessage} Your words are safe — press Save draft, or try the photo again.",'zh-CN':"照片未保存：{errorMessage} 您写的内容都还在 — 请按「保存草稿」，或再试一次上传照片。",ms:"Foto tidak disimpan: {errorMessage} Apa yang anda tulis masih ada — tekan Simpan draf, atau cuba foto itu sekali lagi."}),
  photoNotSavedDraftSavedWithoutIt:Object.freeze({en:"Photo was not saved: {errorMessage} This draft was saved without it.",'zh-CN':"照片没有保存：{errorMessage} 草稿已经保存，只是没有照片。",ms:"Foto tidak disimpan: {errorMessage} Draf ini disimpan tanpa foto."}),
  didNotFinishNothingLostPressAgain:Object.freeze({en:"This did not finish: {errorMessage} Nothing was lost — press again.",'zh-CN':"这一步没有完成：{errorMessage} 没有任何东西丢失 — 请再按一次。",ms:"Ini tidak selesai: {errorMessage} Tiada apa-apa yang hilang — tekan sekali lagi."}),
  countingProgrammeUsesBetweenDates:Object.freeze({en:"Counting how many times each programme was used between {fromDate} and {toDate}. Leave both blank for all time.",'zh-CN':"统计每个方案在 {fromDate} 到 {toDate} 之间被用了多少次。两个日期都留空就是全部时间。",ms:"Mengira berapa kali setiap program digunakan antara {fromDate} dan {toDate}. Biarkan kedua-duanya kosong untuk sepanjang masa."}),
  voucherExpiresDaysAfterSent:Object.freeze({en:"Voucher expires {days} days after it is sent",'zh-CN':"优惠券在发出后 {days} 天到期",ms:"Baucar tamat tempoh {days} hari selepas ia dihantar"}),
  afterTheySpendAmount:Object.freeze({en:"After they spend {amount}",'zh-CN':"在他们消费满 {amount} 之后",ms:"Selepas mereka membelanjakan {amount}"}),
  shortenToStamps:Object.freeze({en:"Shorten to {maxStamps} stamps",'zh-CN':"缩短到 {maxStamps} 个印章",ms:"Pendekkan kepada {maxStamps} setem"}),
  stampHasNoGiftAddOne:Object.freeze({en:"Stamp {stampNumber} has no gift. Add one.",'zh-CN':"第 {stampNumber} 个印章还没有礼物。加一个。",ms:"Setem {stampNumber} tiada hadiah. Tambah satu."}),
  noGiftsYetStartOneEveryStamps:Object.freeze({en:"No gifts yet — a good starting point is one every {everyStamps} stamps. Tap stamp {startStamp} to begin.",'zh-CN':"还没有礼物 — 好的起点是每 {everyStamps} 个印章送一份。点第 {startStamp} 个印章开始。",ms:"Belum ada hadiah — permulaan yang baik ialah satu hadiah setiap {everyStamps} setem. Ketik setem {startStamp} untuk mula."}),
  weMissYouAwayDays:Object.freeze({en:"We miss you — away {days} days",'zh-CN':"我们想您了 — {days} 天没来了",ms:"Kami rindu anda — {days} hari tidak datang"}),
  stampCardIsAtMostStampsLongChooseBetween:Object.freeze({en:"A stamp card is at most {maxStamps} stamps long, so a gift cannot sit on stamp {chosenStamp}. Choose a stamp between 1 and {upperBound}.",'zh-CN':"集章卡最长 {maxStamps} 个印章，所以礼物不能放在第 {chosenStamp} 个印章上。请选 1 到 {upperBound} 之间的印章。",ms:"Kad setem paling panjang {maxStamps} setem, jadi hadiah tidak boleh berada pada setem {chosenStamp}. Pilih setem antara 1 dan {upperBound}."}),
  tierSavedButBenefitsCouldNotBeStored:Object.freeze({en:"The tier was saved, but its benefits could not be stored — {errorMessage}",'zh-CN':"等级已保存，但等级的优惠没能存下来 — {errorMessage}",ms:"Tahap itu telah disimpan, tetapi faedahnya tidak dapat disimpan — {errorMessage}"}),
  ofTreatmentCustomersHaveManualReceiptConfirmation:Object.freeze({en:"{confirmedCount} of {treatmentTotal} treatment customers have an explicit manual receipt confirmation.",'zh-CN':"{treatmentTotal} 位实验组顾客中，有 {confirmedCount} 位经人工明确确认已收到。",ms:"{confirmedCount} daripada {treatmentTotal} pelanggan kumpulan ujian mempunyai pengesahan manual yang jelas bahawa mereka telah menerimanya."}),
  giveBonusStamps:Object.freeze({en:"Give {stampCount} bonus stamps",'zh-CN':"赠送 {stampCount} 个额外印花",ms:"Beri {stampCount} setem bonus"}),
  multiplyPointsBy:Object.freeze({en:"Multiply points by {multiplier}x",'zh-CN':"积分乘以 {multiplier} 倍",ms:"Darab mata dengan {multiplier}x"}),
  reactivateRuleRecordWhyLiftingPause:Object.freeze({en:"Reactivate \"{ruleName}\". It will start running again immediately — record why you are lifting the pause.",'zh-CN':"重新启用“{ruleName}”。它会立即再次运行 — 请写下您解除暂停的原因。",ms:"Aktifkan semula \"{ruleName}\". Ia akan mula berjalan semula serta-merta — catat sebab anda membatalkan jeda itu."}),
  assumesAverageBillOverLast30Days:Object.freeze({en:"Assumes an average bill of {averageBill} over the last 30 days; real cost varies with bill size and match rate.",'zh-CN':"按过去 30 天的平均账单 {averageBill} 计算；实际成本会随账单大小和规则触发的次数而变。",ms:"Menganggap purata bil {averageBill} dalam 30 hari lalu; kos sebenar berubah mengikut saiz bil dan berapa kerap peraturan ini padan."}),
  onePointCostsYouTypeYourCost:Object.freeze({en:"One point costs you {currency} {costPerPoint}. Type your cost and the points fill in — change them if you want.",'zh-CN':"一个积分的成本是 {currency} {costPerPoint}。输入您的成本，积分数会自动填好 — 想改也可以。",ms:"Satu mata berkos {currency} {costPerPoint} kepada anda. Taip kos anda dan mata akan diisi sendiri — ubah jika anda mahu."}),
  publishedReferralSettingsCouldNotBeSaved:Object.freeze({en:"Published. The referral settings could not be saved — {errorMessage} Press retry.",'zh-CN':"已发布。推荐设置没能保存 — {errorMessage} 请按重试。",ms:"Diterbitkan. Tetapan rujukan tidak dapat disimpan — {errorMessage} Tekan cuba semula."}),
  commonMeasurementWindowEnds:Object.freeze({en:"The common measurement window ends {endDate}.",'zh-CN':"共同衡量期在 {endDate} 结束。",ms:"Tempoh pengukuran bersama tamat pada {endDate}."}),
  completedWindowMissedCustomerMinimumPerArm:Object.freeze({en:"The completed window did not reach the {minimumCustomers}-customer minimum in each arm.",'zh-CN':"在已结束的衡量期里，每一组都没有达到 {minimumCustomers} 位顾客的最低要求。",ms:"Tempoh yang telah tamat tidak mencapai minimum {minimumCustomers} pelanggan dalam setiap kumpulan."}),
  markCampaignCompleteConfirm:Object.freeze({en:"Mark \"{campaignName}\" complete? Its sealed measurement evidence stays viewable and observed returns can still be refreshed, but no new campaign reward entitlements can be prepared.",'zh-CN':"把“{campaignName}”标记为完成？已封存的衡量记录仍然可以查看，回头顾客的数字也还能更新，但不能再为这个活动准备新的奖励资格。",ms:"Tandakan \"{campaignName}\" sebagai selesai? Bukti pengukuran yang telah dimeteraikan kekal boleh dilihat dan bilangan pelanggan yang kembali masih boleh dikemas kini, tetapi tiada kelayakan ganjaran baharu boleh disediakan untuk kempen ini."}),
  cancelPlaybookConfirm:Object.freeze({en:"Cancel \"{playbookName}\"? This stops the playbook. Any recorded evidence is kept.",'zh-CN':"取消“{playbookName}”？这会停止这个方案。已记录的证据会保留。",ms:"Batalkan \"{playbookName}\"? Ini menghentikan pelan tindakan ini. Sebarang bukti yang direkodkan akan disimpan."}),
  bringBackLapsedRegularsDefaultName:Object.freeze({en:"Bring back lapsed regulars · {date}",'zh-CN':"召回流失的老顾客 · {date}",ms:"Bawa balik pelanggan tetap yang sudah lama tidak datang · {date}"}),
  giveStoreCreditAmount:Object.freeze({en:"Give {amount} store credit",'zh-CN':"赠送 {amount} 店内额度",ms:"Beri kredit kedai {amount}"}),
  giveBonusPoints:Object.freeze({en:"Give {points} bonus points",'zh-CN':"赠送 {points} 额外积分",ms:"Beri {points} mata bonus"}),
  earnOneStampPerAmountSpent:Object.freeze({en:"Earn 1 stamp per {amount} spent",'zh-CN':"每消费 {amount} 赚 1 个印花",ms:"Dapat 1 setem bagi setiap {amount} dibelanjakan"}),
  salesFullyPaidOfTotal:Object.freeze({en:"{paidCount} of {totalCount} sales are fully paid.",'zh-CN':"{totalCount} 笔销售中，有 {paidCount} 笔已付清。",ms:"{paidCount} daripada {totalCount} jualan telah dibayar penuh."}),
  cameBackWithinDaysHeading:Object.freeze({en:"Came back within {days} days",'zh-CN':"{days} 天内再次到访",ms:"Datang semula dalam {days} hari"}),
  ageKnownForVisits:Object.freeze({en:"Age known for {knownCount} of {totalCount} visits.",'zh-CN':"{totalCount} 次到访中，有 {knownCount} 次知道年龄。",ms:"Umur diketahui bagi {knownCount} daripada {totalCount} kunjungan."}),
  aboutAmountOfUsualSpendAtStake:Object.freeze({en:"About {amount} of their usual spend is at stake.",'zh-CN':"他们平时约 {amount} 的消费可能会流失。",ms:"Kira-kira {amount} daripada perbelanjaan biasa mereka mungkin hilang."}),
  prepaidSessionsOnPlanSittingUnused:Object.freeze({en:"Prepaid sessions on {planName} are sitting unused",'zh-CN':"{planName} 的预付次数一直没用",ms:"Sesi prabayar pada {planName} masih tidak digunakan"}),
  countedWithinDaysOfFirstVisit:Object.freeze({en:"Counted within {days} days of their first visit.",'zh-CN':"以首次到访后 {days} 天内计算。",ms:"Dikira dalam {days} hari selepas kunjungan pertama mereka."}),
  gstRegNo:Object.freeze({en:"GST Reg. No. {number}",'zh-CN':"GST 注册号 {number}",ms:"No. Pendaftaran GST {number}"}),
  waitingForStripeSeconds:Object.freeze({en:"Waiting for Stripe… {seconds}s",'zh-CN':"正在等待 Stripe… {seconds} 秒",ms:"Menunggu Stripe… {seconds}s"}),
  nameSavedPaymentStillConfirming:Object.freeze({en:"{name} is saved. The payment is still confirming.",'zh-CN':"{name} 已保存。付款仍在确认中。",ms:"{name} telah disimpan. Pembayaran masih dalam pengesahan."}),
  typeBranchNameToConfirmDeletion:Object.freeze({en:"Type the branch name to confirm deletion: {branchName}",'zh-CN':"输入分店名称以确认删除：{branchName}",ms:"Taip nama cawangan untuk mengesahkan pemadaman: {branchName}"}),
  onlyPctClassifiedPeekaaWithholdsBelow:Object.freeze({en:"Only {classifiedPct}% of service &amp; retail revenue is classified — Peekaa withholds this view below {thresholdPct}%.",'zh-CN':"服务和零售收入只有 {classifiedPct}% 已分类 — 低于 {thresholdPct}% 时 Peekaa 不会显示这个视图。",ms:"Hanya {classifiedPct}% daripada hasil perkhidmatan dan runcit dikelaskan — Peekaa tidak menunjukkan paparan ini di bawah {thresholdPct}%."}),
  notEnoughDataFewerThan:Object.freeze({en:"Not enough data yet (fewer than {count}).",'zh-CN':"数据还不够（少于 {count}）。",ms:"Data belum cukup lagi (kurang daripada {count})."}),
  captionNoBottleneckYet:Object.freeze({en:"{caption} No bottleneck can be named yet.",'zh-CN':"{caption} 目前还无法指出瓶颈。",ms:"{caption} Belum ada halangan yang dapat dikenal pasti lagi."}),
  showingAllBranchesCompanyCode:Object.freeze({en:"Showing all branches · company code {companyCode}",'zh-CN':"显示所有分店 · 公司代码 {companyCode}",ms:"Menunjukkan semua cawangan · kod syarikat {companyCode}"}),
  acrossAllBranchesVisitsRevenueCustomers:Object.freeze({en:"Across all branches: {visits} valid visits · {revenue} · {customers} customers.",'zh-CN':"所有分店合计：{visits} 次有效到访 · {revenue} · {customers} 位客户。",ms:"Bagi semua cawangan: {visits} kunjungan sah · {revenue} · {customers} pelanggan."}),
  parkBottleKeptForDays:Object.freeze({en:"Park a bottle and it is kept for {days} days.",'zh-CN':"寄存酒瓶后，会为顾客保管 {days} 天。",ms:"Simpan sebotol dan ia dijaga selama {days} hari."}),
  keptMoreDays:Object.freeze({en:"Kept {days} more days",'zh-CN':"再保管 {days} 天",ms:"Disimpan {days} hari lagi"}),
  publishedSwitchNotAppliedRetry:Object.freeze({en:"Published. The programme switch could not be applied — {reason} Press retry.",'zh-CN':"已发布。计划开关未能应用 — {reason} 请按「重试」。",ms:"Diterbitkan. Suis program tidak dapat digunakan — {reason} Tekan Cuba semula."}),
  draftVersionAuthorAndCheckRules:Object.freeze({en:"Draft v{version}. Author and check rules — the publish preview shows what will run before anything goes live.",'zh-CN':"草稿 v{version}。编写并检查规则 — 发布预览会在上线前显示哪些内容会运行。",ms:"Draf v{version}. Bina dan semak peraturan — pratonton terbitan menunjukkan apa yang akan berjalan sebelum apa-apa menjadi langsung."}),
  ...
  usuallyVisitsEveryDaysLastSeenDaysAgo:Object.freeze({en:"Usually visits every {cadenceDays} days · last seen {daysSinceSeen} days ago.",'zh-CN':"通常每 {cadenceDays} 天来一次 · 上次来是 {daysSinceSeen} 天前。",ms:"Biasanya datang setiap {cadenceDays} hari · kali terakhir {daysSinceSeen} hari lalu."}),
  customerUsuallyVisitsEveryDaysLastSeenDaysAgo:Object.freeze({en:"{customerName} usually visits every {cadenceDays} days. Last seen {daysSinceSeen} days ago.",'zh-CN':"{customerName} 通常每 {cadenceDays} 天来一次。上次来是 {daysSinceSeen} 天前。",ms:"{customerName} biasanya datang setiap {cadenceDays} hari. Kali terakhir {daysSinceSeen} hari lalu."}),
  customerIsOverdueAgainstTheirOwnVisitRhythm:Object.freeze({en:"{customerName} is overdue against their own visit rhythm.",'zh-CN':"{customerName} 已经超过了自己平常的到访间隔。",ms:"{customerName} sudah lewat berbanding kebiasaan kunjungannya sendiri."}),
  aboutMonthlyRegularSpendMayBeAtRisk:Object.freeze({en:"About {monthlySpend}/month of regular spend may be at risk.",'zh-CN':"每月约 {monthlySpend} 的熟客消费可能有风险。",ms:"Kira-kira {monthlySpend}/bulan perbelanjaan pelanggan tetap mungkin berisiko."}),
  percentOfYourMoneyIsSortedIntoCategories:Object.freeze({en:"{percent}% of your money is sorted into categories.",'zh-CN':"您的收入中有 {percent}% 已经归入类别。",ms:"{percent}% daripada wang anda sudah disusun mengikut kategori."}),
  utilisationPercentOfBranchOpenTeamHoursScheduled:Object.freeze({en:"Utilisation: {percent} percent of the branch-open team hours scheduled in this period.",'zh-CN':"利用率：本期排上的工作，占分店营业时段团队工时的百分之 {percent}。",ms:"Penggunaan: {percent} peratus daripada waktu pasukan semasa cawangan buka telah dijadualkan dalam tempoh ini."}),
  comparedWithPriorRangeSameBranchScope:Object.freeze({en:"Compared with {priorFrom} to {priorTo} on the same branch scope.",'zh-CN':"与 {priorFrom} 至 {priorTo} 比较，分店范围相同。",ms:"Dibandingkan dengan {priorFrom} hingga {priorTo} pada skop cawangan yang sama."}),
  lifecycleFiguresUnavailableNoPurchaseLinkedToCustomer:Object.freeze({en:"Lifecycle figures are unavailable because none of {purchaseCount} eligible recorded purchases are linked to a customer.",'zh-CN':"生命周期数据不可用，因为这 {purchaseCount} 笔合格的已记录消费中，没有一笔关联到顾客。",ms:"Angka kitaran hayat tidak tersedia kerana tiada satu pun daripada {purchaseCount} pembelian direkod yang layak dipautkan kepada pelanggan."}),
  deleteTemplateTeammatesKeepTheirModules:Object.freeze({en:"Delete the \"{templateName}\" template? Teammates who were given these modules keep them — only the saved shortcut goes.",'zh-CN':"删除「{templateName}」模板？已获得这些模块的团队成员仍然保留权限 — 消失的只是这个已保存的快捷方式。",ms:"Padam templat \"{templateName}\"? Rakan sepasukan yang telah diberi modul ini tetap memilikinya — hanya pintasan yang disimpan itu hilang."}),
  declineAppAccessForTeammate:Object.freeze({en:"Decline app access for {staffName}? Their sign-in is disconnected, they stay on your team list, and you can send them a new invite later.",'zh-CN':"拒绝 {staffName} 的应用访问权限？他们的登录会被断开，但仍留在您的团队名单上，之后您可以再给他们发新的邀请。",ms:"Tolak akses aplikasi untuk {staffName}? Log masuk mereka diputuskan, mereka kekal dalam senarai pasukan anda, dan anda boleh menghantar jemputan baharu kepada mereka kemudian."}),
  switchTeammateOffLosesAccessAndSeat:Object.freeze({en:"Switch {staffName} off? They lose access straight away and stop using a paid seat. Everything they have already done stays on record, and you can switch them back on any time.",'zh-CN':"停用 {staffName}？他们会立即失去访问权限，也不再占用付费席位。他们已经做过的一切都会留在记录里，您随时可以重新启用。",ms:"Matikan {staffName}? Mereka hilang akses serta-merta dan berhenti menggunakan kerusi berbayar. Semua yang mereka sudah lakukan kekal dalam rekod, dan anda boleh menghidupkannya semula pada bila-bila masa."}),
  worthAboutOfWorkAlreadyPaidFor:Object.freeze({en:"Worth about {amount} of work already paid for.",'zh-CN':"大约 {amount} 的服务已经付过款。",ms:"Kira-kira {amount} nilai kerja yang sudah dibayar."}),
  ageKnownForPercent:Object.freeze({en:"Age known for {agePercent}%",'zh-CN':"已知年龄 {agePercent}%",ms:"Umur diketahui untuk {agePercent}%"}),
  ...
  /* nestly_v963: this row shipped its own escape sequence. The en value was double-escaped, so an
     ...
     Left the key alone (renaming it is churn the owner cannot see); fixed what they read. */
  ...
  /* nestly_v962: the noun-as-value class. A word chosen by a ternary and handed to a sentence
     as a VALUE is preserved verbatim, so it reads English inside an otherwise Chinese or Malay
     sentence — the same defect v961 caught in billingCadenceWordV764, one shape smaller. Key
     variants at the call site, never a translated noun handed to an English frame. */
  onePointWord:Object.freeze({en:"{count} point",'zh-CN':"{count} 积分",ms:"{count} mata"}),
  manyPointsWord:Object.freeze({en:"{count} points",'zh-CN':"{count} 积分",ms:"{count} mata"}),
  amountPerYear:Object.freeze({en:"{amount} / year",'zh-CN':"{amount} / 年",ms:"{amount} / tahun"}),
  amountPerMonth:Object.freeze({en:"{amount} / month",'zh-CN':"{amount} / 月",ms:"{amount} / bulan"}),
  confirmFailedReason:Object.freeze({en:"Confirm failed. {reason}",'zh-CN':"确认失败。{reason}",ms:"Pengesahan gagal. {reason}"}),
  declineFailedReason:Object.freeze({en:"Decline failed. {reason}",'zh-CN':"拒绝失败。{reason}",ms:"Penolakan gagal. {reason}"}),
  oneBookingToday:Object.freeze({en:"{count} booking today.",'zh-CN':"今天有 {count} 个预约。",ms:"{count} tempahan hari ini."}),
  manyBookingsToday:Object.freeze({en:"{count} bookings today.",'zh-CN':"今天有 {count} 个预约。",ms:"{count} tempahan hari ini."}),
  oneBookingOnDay:Object.freeze({en:"{count} booking on {day}.",'zh-CN':"{day} 有 {count} 个预约。",ms:"{count} tempahan pada {day}."}),
  manyBookingsOnDay:Object.freeze({en:"{count} bookings on {day}.",'zh-CN':"{day} 有 {count} 个预约。",ms:"{count} tempahan pada {day}."}),
  showingOneSaleForPeriod:Object.freeze({en:"Showing {count} sale · {period}",'zh-CN':"显示 {count} 笔销售 · {period}",ms:"Menunjukkan {count} jualan · {period}"}),
  showingManySalesForPeriod:Object.freeze({en:"Showing {count} sales · {period}",'zh-CN':"显示 {count} 笔销售 · {period}",ms:"Menunjukkan {count} jualan · {period}"}),
  oneActivePlan:Object.freeze({en:"{count} active plan.",'zh-CN':"{count} 个有效方案。",ms:"{count} pelan aktif."}),
  manyActivePlans:Object.freeze({en:"{count} active plans.",'zh-CN':"{count} 个有效方案。",ms:"{count} pelan aktif."}),
  thresholdVisitsSuffix:Object.freeze({en:" · {count} visits",'zh-CN':" · {count} 次到访",ms:" · {count} kunjungan"}),
  ...
  /* nestly_v963: nine templates that were REVIEWED and still shipped half-English. Each took
     ...
     方式". Being in the table is not the same as being translated. One key per form now, and
  ...
  showingManySalesPaymentStateNotApplied:Object.freeze({en:"Showing {count} sales · {period} · payment state could not be read, so it was not applied{workflowNote}",'zh-CN':"显示 {count} 笔销售 · {period} · 读不到付款状态，所以这个筛选没有生效{workflowNote}",ms:"Menunjukkan {count} jualan · {period} · keadaan pembayaran tidak dapat dibaca, jadi ia tidak digunakan{workflowNote}"}),
  customerQrRedemptionIsEnabled:Object.freeze({en:"Customer QR redemption is enabled.",'zh-CN':"顾客二维码兑换已开启。",ms:"Penebusan QR pelanggan dihidupkan."}),
  customerQrRedemptionIsOff:Object.freeze({en:"Customer QR redemption is off.",'zh-CN':"顾客二维码兑换已关闭。",ms:"Penebusan QR pelanggan dimatikan."}),
  customerQrRedemptionIsEnabledBookingSettingsPreserved:Object.freeze({en:"Customer QR redemption is enabled. Booking and appointment settings were preserved.",'zh-CN':"顾客二维码兑换已开启。预订和预约设置保持不变。",ms:"Penebusan QR pelanggan dihidupkan. Tetapan tempahan dan janji temu dikekalkan."}),
  customerQrRedemptionIsOffBookingSettingsPreserved:Object.freeze({en:"Customer QR redemption is off. Booking and appointment settings were preserved.",'zh-CN':"顾客二维码兑换已关闭。预订和预约设置保持不变。",ms:"Penebusan QR pelanggan dimatikan. Tetapan tempahan dan janji temu dikekalkan."}),
  referralsCouldNotBeTurnedOn:Object.freeze({en:"Referrals could not be turned on — {errorMessage}",'zh-CN':"推荐功能无法开启 — {errorMessage}",ms:"Rujukan tidak dapat dihidupkan — {errorMessage}"}),
  referralsCouldNotBeTurnedOff:Object.freeze({en:"Referrals could not be turned off — {errorMessage}",'zh-CN':"推荐功能无法关闭 — {errorMessage}",ms:"Rujukan tidak dapat dimatikan — {errorMessage}"}),
  enterHowManyVisitsCustomerNeedsForThisTier:Object.freeze({en:"Enter how many visits a customer needs for this tier.",'zh-CN':"请输入顾客达到此等级需要多少次到访。",ms:"Masukkan berapa banyak kunjungan yang diperlukan pelanggan untuk peringkat ini."}),
  enterHowManyPointsCustomerNeedsForThisTier:Object.freeze({en:"Enter how many points a customer needs for this tier.",'zh-CN':"请输入顾客达到此等级需要多少积分。",ms:"Masukkan berapa banyak mata yang diperlukan pelanggan untuk peringkat ini."}),
  pricePerYearToCredit:Object.freeze({en:"{price}/yr → {credit} credit each period",'zh-CN':"{price}/年 → 每期 {credit} 额度",ms:"{price}/thn → kredit {credit} setiap tempoh"}),
  pricePerMonthToCredit:Object.freeze({en:"{price}/mo → {credit} credit each period",'zh-CN':"{price}/月 → 每期 {credit} 额度",ms:"{price}/bln → kredit {credit} setiap tempoh"}),
  /* nestly_v963: the same defect where the word came from a helper rather than a ternary —
     tillUnitNounV430 and growPointsUnitV326 both RETURN an English noun. recordedCurrentBalance
     had a second render site the v961 pass missed; it now uses the per-unit keys that pass
     already made. Found by asking the TABLE which rows still carry a word-shaped slot, which
     is the only question that reaches a word arriving from a function call. */
  createGiftsRedeemWithStamps:Object.freeze({en:"Create new gifts for your customers to redeem with stamps.",'zh-CN':"创建新的礼物，供顾客用印花兑换。",ms:"Cipta hadiah baharu untuk pelanggan anda tebus dengan setem."}),
  createGiftsRedeemWithPoints:Object.freeze({en:"Create new gifts for your customers to redeem with points.",'zh-CN':"创建新的礼物，供顾客用积分兑换。",ms:"Cipta hadiah baharu untuk pelanggan anda tebus dengan mata."}),
  giftsAvailableWithStamps:Object.freeze({en:"These gifts are available for your customers to redeem with their stamps.",'zh-CN':"这些礼物可供顾客用其印花兑换。",ms:"Hadiah ini tersedia untuk pelanggan anda tebus dengan setem mereka."}),
  giftsAvailableWithPoints:Object.freeze({en:"These gifts are available for your customers to redeem with their points.",'zh-CN':"这些礼物可供顾客用其积分兑换。",ms:"Hadiah ini tersedia untuk pelanggan anda tebus dengan mata mereka."}),
  /* nestly_v963 (second pass): five more, found by the TABLE-side question rather than the
     call-site one — the word arrived from a helper or a lookup object, not a visible ternary.
...
const WORKSPACE_INTERPOLATED_UI_INVENTORY_V97=Object.freeze([
  ...
  'discountsGivenButNoStaffAttributed',
  'noneOfYourIdentifiedCustomersVisitMoreThanOneOutlet',
  'identifiedCustomersVisitingMoreThanOneOutlet',
  'pointsEarnedInLast90DaysNoneExpired',
  'pointsEarnedInLast90DaysExpiredUnused',
  'membersVisitDaysVersusNonMembers',
  'staffRosteredHoursWithZeroSalesClause',
  'andStaffRosteredHoursWithZeroSalesClause',
  'staffRosteredHoursButNoAttributedSales',
  'thisRewardExpiredOn',
  'somethingWentWrongNothingRedeemedQuoteReference',
  'thisGiftNeedsAtLeastOnTheSale',
  'scanningIsPausedForThisCode',
  'chooseARangeOfDaysOrFewer',
  'salesAreLevelAndSoIsTheAverageSale',
  'salesAreLevelBiggestAverageSaleIs',
  'closesTheMostSalesAverageSaleIsLevel',
  'leadsOnBothMostSalesAndBiggestAverageSale',
  'nothingBookedOnDaySummary',
  'costUpToAmount',
  'onPaceForAmountThisMonth',
  'holdsMoreThanOnePackageUsesListedByName',
  'giveRewardNowNoPurchaseNeeded',
  'soldPointsEarnedAndTotal',
  'compensatingReversalRowAuditId',
  'replacementSaleRowCorrectsEarlierAmountAuditId',
  'originalSaleRowLaterCorrectedAuditId',
  'originalSaleRowFullyReversedAuditId',
  'switchServiceOffConfirm',
  'customersMissingMarketingConsentOrEligibilityEvidence',
  'pointsForEverySgd1Spent',
  'useOnePackageSessionForCustomerConfirm',
  'saleEarnedPointsOnTotalLinesAreShares',
  'unlockAtAmountSpent',
  'rewardStopsBeingOfferedToCustomers',
  'itemNoLongerOnSaleChooseAnother',
  'newSignUpsGetItemFreeAfterMinimumSpend',
  'newSignUpsGetItemFreeNoMinimumSpend',
  'earnOneStampPerSgdSpent',
  'earnPointsPerSgdOneSpent',
  'thatPhotoIsMbTheLimitIsTenMbChooseSmaller',
  'liveNowEndsDate',
  'publishedButCustomersCannotSeeItYetItStarts',
  'endOfferCustomersStopSeeingItRecordKept',
  'deleteDraftCannotBeUndoneNoCustomerHasSeenIt',
  'photoWasNotSavedYourWordsAreSafePressSaveDraft',
  'photoNotSavedDraftSavedWithoutIt',
  'didNotFinishNothingLostPressAgain',
  'countingProgrammeUsesBetweenDates',
  'voucherExpiresDaysAfterSent',
  'afterTheySpendAmount',
  'shortenToStamps',
  'stampHasNoGiftAddOne',
  'noGiftsYetStartOneEveryStamps',
  'weMissYouAwayDays',
  'stampCardIsAtMostStampsLongChooseBetween',
  'tierSavedButBenefitsCouldNotBeStored',
  'ofTreatmentCustomersHaveManualReceiptConfirmation',
  'giveBonusStamps',
  'multiplyPointsBy',
  'reactivateRuleRecordWhyLiftingPause',
  'assumesAverageBillOverLast30Days',
  'onePointCostsYouTypeYourCost',
  'publishedReferralSettingsCouldNotBeSaved',
  'commonMeasurementWindowEnds',
  'completedWindowMissedCustomerMinimumPerArm',
  'markCampaignCompleteConfirm',
  'cancelPlaybookConfirm',
  'bringBackLapsedRegularsDefaultName',
  'giveStoreCreditAmount',
  'giveBonusPoints',
  'earnOneStampPerAmountSpent',
  'salesFullyPaidOfTotal',
  'cameBackWithinDaysHeading',
  'ageKnownForVisits',
  'aboutAmountOfUsualSpendAtStake',
  'prepaidSessionsOnPlanSittingUnused',
  'countedWithinDaysOfFirstVisit',
  'gstRegNo',
  'waitingForStripeSeconds',
  'nameSavedPaymentStillConfirming',
  'typeBranchNameToConfirmDeletion',
  'onlyPctClassifiedPeekaaWithholdsBelow',
  'notEnoughDataFewerThan',
  'captionNoBottleneckYet',
  'showingAllBranchesCompanyCode',
  'acrossAllBranchesVisitsRevenueCustomers',
  'parkBottleKeptForDays',
  'keptMoreDays',
  'publishedSwitchNotAppliedRetry',
  'draftVersionAuthorAndCheckRules',
  ...
  'usuallyVisitsEveryDaysLastSeenDaysAgo',
  'customerUsuallyVisitsEveryDaysLastSeenDaysAgo',
  'customerIsOverdueAgainstTheirOwnVisitRhythm',
  'aboutMonthlyRegularSpendMayBeAtRisk',
  'percentOfYourMoneyIsSortedIntoCategories',
  'utilisationPercentOfBranchOpenTeamHoursScheduled',
  'comparedWithPriorRangeSameBranchScope',
  'lifecycleFiguresUnavailableNoPurchaseLinkedToCustomer',
  'deleteTemplateTeammatesKeepTheirModules',
  'declineAppAccessForTeammate',
  'switchTeammateOffLosesAccessAndSeat',
  'worthAboutOfWorkAlreadyPaidFor',
  'ageKnownForPercent',
  'moneyBackRequestDeadlineUnderAcceptedTerms',
  'resumeRenewalNextPaymentAmount',
  'youCanResumeUntilDate',

  'itemsTicked',
  'nothingChangesYetThey',
  'nothingChangesYetIt',
  'stampGiftGivenBack',
  'stampGiftsGivenBack',
  'stampCardOpenAgain',
  ...
  'exactReplayVerified',
  'exactCompensationClaimCheck',
  'todaysScheduleCouldNotLoad',
  'scheduleForDayCouldNotLoad',
  'ledgerTotalPoints',
  'ledgerTotalStamps',
  'ledgerTotalPointsRunning',
  'ledgerTotalStampsRunning',
  'birthdayBenefitLiveWindow',
  'birthdayBenefitPausedWindow',
  'atLivePublishLimit',
  'youCanPublishMore',
  'complimentaryPublishingEnds',
  'availableOnlyAtBranch',
  'availableOnlyAtCurrentBranch',
  'oneGiftPastCardEnd',
  'giftsPastCardEnd',
  'reachedAtThreshold',
  'reachedAtThresholdMultiplier',
  'couldNotBePrepared',
  'couldNotBePreparedAndMore',
  'pauseReasonWas',
  'pausedByActor',
  'pausedAtServerTime',
  'paidValueExpiryNone',
  ...
  'bonusExpiryDay',
  'bonusExpiryDays',
  'iConfirmCustomerPaid',
  'iConfirmCustomerPaidAmount',
  'collectingIssuing',
  'collectingIssuingWithBonus',
  'dayBlocked',
  'daysBlocked',
  'dayCouldNotBeBlocked',
  'daysCouldNotBeBlocked',
  'sessionsLeftBought',
  'sessionsLeftBoughtUseBy',
  'recordSaleAddsGst',
  'oneBranchAwaitingPayment',
  'branchesAwaitingPayment',
  'medianVsMean',
  'medianVsMeanTopCustomer',
  'categoryViewCovers',
  'categoryViewCoversProjected',
  'lastSaleWas',
  'lastSaleNeverRecorded',
  'identityCoverage',
  'identityCoveragePct',
  'codeStillWorks',
  'codeStillWorksUntil',
  'requiredDependenciesAddedAsRead',
  'skippedUnavailableModules',
  'leaveBlankAndShown',
  'leaveBlankNoLineShown',
  'upToPhotos',
  'upToPhotosAdded',

  'saleReversalAmounts',
  'saleReversalAmountsReplayed',
  'redemptionReversalAmounts',
  'redemptionReversalAmountsReplayed',
  'exactCompensationPointsCheck',
  'profileFiguresBranchListUnavailable',
  'profileFiguresAdminScopeUnconfirmed',
  'profileFiguresStaffScopeUnconfirmed',
  'tierIsSetUpPausedReview',
  'tierIsSetUpPausedSave',
  'tiersAreSetUpPausedReview',
  'tiersAreSetUpPausedSave',
  'creditFullyUsedLeaves',
  'creditFullyUsedLeavesReview',
  'pricedItemTypicalSale',
  'pricedItemsTypicalSale',
  'visitInDaysReward',
  'visitsInDaysReward',
  'leaveBlankCustomersSee',
  'liveOfferPageCountPickHome',
  'busiestOpenTimes',
  'busiestOpenTimesUnknown',
  'quietestOpenTimes',
  'quietestOpenTimesUnknown',
  'returnedOnTheirOwnNetRemoves',
  'returnedThenComparison',
  'returnedCount',
  'expenseRecordedOn',
  'expenseRecordedOnOverhead',
  'expenseRecordedOnUnknownDate',
  'expenseRecordedOnUnknownDateOverhead',
  ...
  'giftBecomesAvailableAgain','previousSpanLegend','referralItemIsFree',
  ...
  'referralPaysFreeGift','friendQualifyingMinCurrency','letCustomerKnow',
  'blockAtMostDays',
  ...
  'pointsPerCurrencyOne','showingGiftsRetiredYears',
  ...
  'noCatalogueMatchForSearch','viewAllTierBenefits','scanToOpenRewardsAt',
  ...
  'oneBookingOnDay',
  'manyBookingsOnDay',
  'showingOneSaleForPeriod',
  'showingManySalesForPeriod',
  'oneActivePlan',
  'manyActivePlans',
  'thresholdVisitsSuffix',
  'thresholdPointsSuffix',
  'tierThresholdVisits',
  'tierThresholdPoints',
  'soldToOneCustomerSavingApplies',
  'soldToManyCustomersSavingApplies',
  'deleteCatalogueItemConfirmService',
  'deleteCatalogueItemConfirmProduct',
  'annualBillingNotOfferedAtThisCapacity',
  'monthlyBillingNotOfferedAtThisCapacity',
  'recordedOneVisitAndRevenueNotEnoughForTrend',
  'recordedManyVisitsAndRevenueNotEnoughForTrend',
  'showingOneSalePaymentStateNotApplied',
  'showingManySalesPaymentStateNotApplied',
  'customerQrRedemptionIsEnabled',
  'customerQrRedemptionIsOff',
  'customerQrRedemptionIsEnabledBookingSettingsPreserved',
  'customerQrRedemptionIsOffBookingSettingsPreserved',
  'referralsCouldNotBeTurnedOn',
  'referralsCouldNotBeTurnedOff',
  'enterHowManyVisitsCustomerNeedsForThisTier',
  'enterHowManyPointsCustomerNeedsForThisTier',
  'pricePerYearToCredit',
  'pricePerMonthToCredit',
  'createGiftsRedeemWithStamps',
  'createGiftsRedeemWithPoints',
  'giftsAvailableWithStamps',
  'giftsAvailableWithPoints',
  'percentChangeUpVersusRange',
  'percentChangeDownVersusRange',
  'percentChangeLevelVersusRange',
  'noStampsEarnedForThisPurchase',
  'noPointsEarnedForThisPurchase',
  'tiersAreEarnedByVisitsNow',
  'tiersAreEarnedByDollarsSpentNow',
  'tiersAreEarnedByPointsEarnedNow',
  'enterHowManyStampsThisRewardCosts',
  'enterHowManyPointsThisRewardCosts',
  'cardCustomersSeeIsOneStampLong',
  'cardCustomersSeeIsManyStampsLong',
  'tiersAreEarnedByVisitsNowYourOne',
  'tiersAreEarnedByVisitsNowYourMany',
  'tiersAreEarnedByDollarsSpentNowYourOne',
  'tiersAreEarnedByDollarsSpentNowYourMany',
  'tiersAreEarnedByPointsEarnedNowYourOne',
  'tiersAreEarnedByPointsEarnedNowYourMany',
]);
...
async function svRunTopupFlow({branches,state,testOnly}){
  ...
  function render(){
    ...
    if(st.step==='customer'){
      ...
      const planRadios=st.plans.length?st.plans.map(pl=>{
        ...
        return `<label class="row" style="gap:10px;align-items:flex-start;padding:10px;border:1px solid var(--line);border-radius:10px;margin-top:8px${pl.ok?'':';opacity:.7'}">
          ...
          <div style="flex:1;min-width:0"><div style="font-weight:700">${esc(pl.plan_name||'Plan')}</div>
            <div class="muted small" style="margin-top:2px">Pay <b>${money(Number(pl.price_cents||0))}</b>${Number(pl.bonus_cents||0)>0?` · <span>bonus</span> <b>${money(Number(pl.bonus_cents))}</b>`:''} · <span>total value</span> <b>${money(Number(pl.total_usable_cents||0))}</b></div>
            <div class="muted small">${pl.paid_expiry_days==null?workspaceTemplateHtmlV97('paidValueExpiryNone',{}):workspaceTemplateHtmlV97(Number(pl.paid_expiry_days)===1?'paidValueExpiryDay':'paidValueExpiryDays',{days:Number(pl.paid_expiry_days)})}${Number(pl.bonus_cents||0)>0?' · '+(pl.bonus_expiry_days==null?workspaceTemplateHtmlV97('bonusExpiryNone',{}):workspaceTemplateHtmlV97(Number(pl.bonus_expiry_days)===1?'bonusExpiryDay':'bonusExpiryDays',{days:Number(pl.bonus_expiry_days)})):''}</div>
      ...
      const confirmBox=needsReference()?`<label class="row small" style="gap:8px;align-items:flex-start;margin-top:8px"><input type="checkbox" id="svtConfirm"${st.staffConfirmed?' checked':''} style="margin-top:3px"><span>${p?workspaceTemplateHtmlV97('iConfirmCustomerPaidAmount',{amount:money(Number(p.price_cents||0))}):workspaceTemplateHtmlV97('iConfirmCustomerPaid',{})} <b><span>${esc(BRAND.productName)}</span> has not verified this payment</b> — you are attesting it was received.</span></label>`:'';
      ...
      body=`<div class="cui-card-head"><h3>Confirm this top-up</h3></div>
        <aside class="permission-banner" role="note" style="border-color:var(--line)">${CUI.icon('info',{size:20})}<div>
          <b>${workspaceTemplateHtmlV97(bonus>0?'collectingIssuingWithBonus':'collectingIssuing',{collecting:`${cur} ${(cash/100).toFixed(2)}`,issuing:`${cur} ${(cash/100).toFixed(2)}`,bonus:`${cur} ${(bonus/100).toFixed(2)}`})}</b>
