...
declare
  ...
  v_authenticated_rpc_names constant text[] := array[
    ...
    'customer_create_identity',
    'customer_get_identity',
    'customer_get_wallet',
    'customer_get_business_summary',
    'customer_get_appointments',
    'customer_get_appointments_page',
    'customer_get_loyalty_details',
    'customer_get_reward_catalog',
    'customer_get_packages',
    'customer_get_memberships',
    'customer_issue_link_invitation',
    'customer_get_notification_preferences',
    'customer_portal_capabilities',
    'customer_request_appointment_action',
    'customer_set_notification_preference',
    'customer_unlink_business_link',
    'create_loyalty_config_draft',
    'create_client_field_definition',
    'create_business',
    'create_invite',
    'decide_change',
    'enroll_membership',
    ...
    'get_loyalty_reward_draft',
    'get_retention_config_draft',
    'import_bookings',
    'issue_gift_card',
    ...
    'redeem_reward_at_context',
    'refund_sale',
    'remove_loyalty_branch_override_draft',
    'save_loyalty_config_draft',
    'save_loyalty_branch_override_draft',
    'save_retention_program_draft',
    'save_reward_taxonomy',
    'reverse_sale',
    'reverse_loyalty_redemption',
