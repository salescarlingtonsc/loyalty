...
revoke all privileges on table public.platform_accounting_accounts_v147 from public,anon,authenticated;
revoke all privileges on table public.platform_accounting_policies_v147 from public,anon,authenticated;
revoke all privileges on table public.platform_accounting_period_events_v147 from public,anon,authenticated;
revoke all privileges on table public.platform_accounting_journal_entries_v147 from public,anon,authenticated;
revoke all privileges on table public.platform_accounting_journal_lines_v147 from public,anon,authenticated;
revoke all privileges on table public.platform_financial_document_sequences_v147 from public,anon,authenticated;
revoke all privileges on table public.platform_financial_documents_v147 from public,anon,authenticated;
