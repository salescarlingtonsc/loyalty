...
begin
  ...
  if v_business is null then
    raise exception 'v755 fixture needs at least one business';
  end if;
  ...
  delete from public.billing_provider_events where event_id='evt_v755_probe';
  ...
  raise notice 'v755_corpus: A1-A6 and A8 passed';
end
$v755_test$;
