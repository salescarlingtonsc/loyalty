...
assert.equal(plan.items.length, 467, // + v577 publish preserves tier identity (P0: every programme publish raised 23503 for a tenant with a gift intent; deploy 20260828070000)
