...
assert.equal(plan.items.length, 283, 'canonical plan must contain 45 catalog and 238 pending migrations'); // V283 customer-claim grants
...
assert.equal(pending.length, 238); // V283 customer-claim grants
