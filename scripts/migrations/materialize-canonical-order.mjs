...
assert.equal(plan.items.length, 463, // + v572 retention safety hardening (consent/business gate/cooldown/atomic quota; deploy 20260828020000 — twin-name with the module-toggle v572, parallel-session collision, not a real conflict)
