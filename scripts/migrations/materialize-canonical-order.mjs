...
assert.equal(plan.items.length, 307, 'canonical plan must contain 45 catalog and 262 pending migrations'); // + v311/v312 money wave (W5a/W5b)
...
assert.equal(pending.length, 262); // + v311/v312 money wave (W5a/W5b)
