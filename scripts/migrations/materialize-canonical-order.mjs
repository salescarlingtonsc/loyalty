...
assert.equal(plan.items.length, 476, // + v588 staff signup flow integrity // + v587 join QR names its business // + v586 tier basis reaches the draft // + v581 short-notice/reschedule, v582 attribution wiring, v583 owner toggles
