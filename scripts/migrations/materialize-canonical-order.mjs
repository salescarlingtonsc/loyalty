...
assert.equal(plan.items.length, 294, 'canonical plan must contain 45 catalog and 249 pending migrations'); // V306 both-mode tiers capability
...
assert.equal(pending.length, 249); // V306 both-mode tiers capability
