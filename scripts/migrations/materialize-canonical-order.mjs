...
assert.equal(plan.items.length, 466, // + v574 retention control plane (customer consent capture, platform hold, appointment transactional gate; deploy 20260828050000)
