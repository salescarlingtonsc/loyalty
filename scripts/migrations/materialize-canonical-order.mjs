...
assert.equal(plan.items.length, 297, 'canonical plan must contain 45 catalog and 252 pending migrations'); // + V297-V299 prospecting CRM
...
assert.equal(pending.length, 252); // + V297-V299 prospecting CRM
