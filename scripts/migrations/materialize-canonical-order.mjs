...
assert.equal(pending.length, 297); // + the 2026-08-16 rewards wave (v343/v345/v347/v348/v350/v353/v354/v355/v359/v361/v362) + v311/v312 money wave (W5a/W5b) + v315 lead score repair + v316 taxonomy/match queue repair + v317 restored dependencies + v318 system-managed flag alignment + v313/v314 W6 increment 1 (reward programme identity + switchboard inversion) + v322 owner programme rulings + v323 stamp quest milestones + v325 business bio + v326/v326a points-gift lifecycle + v327 customer branch choice + v327 global customer QR (a second, independent v327 -- parallel-session number collision, not a real conflict) + v328 staff-choice manual confirm + v329 owner reschedule booking request + v330 pending slot block & confirmation template + v329 membership plan lifecycle (a second, independent v329 -- parallel-session number collision, not a real conflict) + v331 tier lifecycle + v332 retention program lifecycle + v340 reward purchase requirement (NOT applied; written for rehearsal)
