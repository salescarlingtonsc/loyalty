...
assert.equal(plan.items.length, 291, 'canonical plan must contain 45 catalog and 246 pending migrations'); // V283 customer-claim grants
...
assert.equal(pending.length, 246); // +v290
