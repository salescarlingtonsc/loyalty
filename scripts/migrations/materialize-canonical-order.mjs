...
assert.equal(plan.items.length, 305, 'canonical plan must contain 45 catalog and 260 pending migrations'); // + v311 conversion-first prospecting + v311 rollback snapshot + v312 business explorer/funnel
