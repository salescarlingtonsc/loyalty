...
assert.equal(plan.items.length, 299, 'canonical plan must contain 45 catalog and 254 pending migrations'); // + v308 programme spine
...
assert.equal(pending.length, 254); // + v308 programme spine
