...
assert.equal(plan.items.length, 293, 'canonical plan must contain 45 catalog and 248 pending migrations'); // V300 growth readbacks
...
assert.equal(pending.length, 248); // V300 growth readbacks
