...
assert.equal(plan.items.length, 284, 'canonical plan must contain 45 catalog and 239 pending migrations'); // V283 customer-claim grants
...
assert.equal(pending.length, 239); // V283 customer-claim grants
