...
assert.equal(plan.items.length, 287, 'canonical plan must contain 45 catalog and 242 pending migrations'); // V283 customer-claim grants
...
assert.equal(pending.length, 242); // +v285
