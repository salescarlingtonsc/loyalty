...
assert.equal(plan.items.length, 298, 'canonical plan must contain 45 catalog and 253 pending migrations'); // + v307 programme read model
...
assert.equal(pending.length, 253); // + v307 programme read model
