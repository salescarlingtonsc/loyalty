...
const SYSTEM_PROMPT = [
  ...
  '- Repeat business: how many customers came back vs were new (repeat_rate_pct), and -',
  '  the single most telling number - of last period\'s NEW customers, how many returned',
  ...
  '- Regulars: name the top customers by their abbreviated labels and what share of revenue',
  '  the top customer carries (top1_share_pct). If one customer carries a large share, say',
  '  plainly that this is a risk as well as a strength.',
