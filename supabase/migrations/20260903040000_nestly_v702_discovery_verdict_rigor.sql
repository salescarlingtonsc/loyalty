...
-- frozen), db/migrations/20260902_nestly_v691_outliers_and_confounders.sql (the LIVE body this
-- migration extract-and-diffs from — grepped: no migration after v691 touches
-- public.get_ci_discovery_v1), db/migrations/20260902_nestly_v693_exclusions_and_typed_verdicts.sql
...
-- 20260902_nestly_v680_ci_envelope.sql (the envelope's own contract). Proven by
