...
-- (db/migrations/20260902_nestly_v676_internal_drain_authority.sql, verification 6.3). Adding a
...
-- 20260902_nestly_v712_spine_wording_closures.sql, is in flight in a sibling session per this
...
begin
  ...
  v_pack := app.v176_evidence_pack(v_biz, 'monthly', current_date - 35, current_date - 5);
