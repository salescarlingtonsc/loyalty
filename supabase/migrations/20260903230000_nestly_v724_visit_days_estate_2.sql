...
begin
  ...
  v_count := (length(v_def) - length(replace(v_def, $v724a666_1$  select count(*) into v_visits
    from public.sales where business_id=p_business and client_id=v_client.id and counts_as_visit;
$v724a666_1$, ''))) / length($v724a666_1$  select count(*) into v_visits
    from public.sales where business_id=p_business and client_id=v_client.id and counts_as_visit;
$v724a666_1$);
  if v_count <> 1 then
  ...
  v_expected := replace(v_def, $v724a666_2$  select count(*) into v_visits
    from public.sales where business_id=p_business and client_id=v_client.id and counts_as_visit;
$v724a666_2$, $v724r666_3$  select count(distinct app.ci_visit_day_v699(occurred_at)) into v_visits
    from public.sales where business_id=p_business and client_id=v_client.id and counts_as_visit;
$v724r666_3$);
  ...
  v_roundtrip := replace(v_after, $v724r666_4$  select count(distinct app.ci_visit_day_v699(occurred_at)) into v_visits
    from public.sales where business_id=p_business and client_id=v_client.id and counts_as_visit;
$v724r666_4$, $v724a666_5$  select count(*) into v_visits
    from public.sales where business_id=p_business and client_id=v_client.id and counts_as_visit;
$v724a666_5$);
  if v_roundtrip <> v_def then
...
begin
  ...
  v_count := (length(v_def) - length(replace(v_def, $v724alcbp_1$  select count(*) into v_visits
    from public.sales where business_id=p_business and client_id=c.id and counts_as_visit;
$v724alcbp_1$, ''))) / length($v724alcbp_1$  select count(*) into v_visits
    from public.sales where business_id=p_business and client_id=c.id and counts_as_visit;
$v724alcbp_1$);
  if v_count <> 1 then
  ...
  v_expected := replace(v_def, $v724alcbp_2$  select count(*) into v_visits
    from public.sales where business_id=p_business and client_id=c.id and counts_as_visit;
$v724alcbp_2$, $v724rlcbp_3$  select count(distinct app.ci_visit_day_v699(occurred_at)) into v_visits
    from public.sales where business_id=p_business and client_id=c.id and counts_as_visit;
$v724rlcbp_3$);
  ...
  v_roundtrip := replace(v_after, $v724rlcbp_4$  select count(distinct app.ci_visit_day_v699(occurred_at)) into v_visits
    from public.sales where business_id=p_business and client_id=c.id and counts_as_visit;
$v724rlcbp_4$, $v724alcbp_5$  select count(*) into v_visits
    from public.sales where business_id=p_business and client_id=c.id and counts_as_visit;
$v724alcbp_5$);
  if v_roundtrip <> v_def then
