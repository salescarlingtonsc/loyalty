...
-- v_has_v683 gate, broken by db/migrations/20260920_nestly_v699_visit_day_authority.sql after this
...
-- follow-up: db/migrations/20260920_nestly_v699_visit_day_authority.sql (a different agent's work,
...
E'  select coalesce(jsonb_agg(x.c || jsonb_build_object(\'rank\', x.rn) order by x.rn), \'[]\'::jsonb)
  ...
  -- NESTLY v705 hotfix — db/migrations/20260920_nestly_v699_visit_day_authority.sql (already applied
