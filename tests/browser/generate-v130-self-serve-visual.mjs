...
export function buildV130SelfServeVisual(app){
  ...
  const plans=[{cadence:'annual',cadence_months:12,base_amount_cents:118800,included_customer_capacity:1000,capacity_block_size:1000,capacity_block_amount_cents:12000,compare_at_monthly_cents:16800,tax_behavior:'exclusive'},{cadence:'monthly',cadence_months:1,base_amount_cents:14800,included_customer_capacity:1000,capacity_block_size:1000,capacity_block_amount_cents:1000,compare_at_monthly_cents:16800,tax_behavior:'exclusive'}];
  const capacityTiers=[{cadence:'annual',capacity_ceiling:10000,amount_cents:118800,sales_assisted_above:false,checkout_available:true},{cadence:'annual',capacity_ceiling:40000,amount_cents:168800,sales_assisted_above:false,checkout_available:false},{cadence:'annual',capacity_ceiling:100000,amount_cents:249900,sales_assisted_above:true,checkout_available:false},{cadence:'monthly',capacity_ceiling:10000,amount_cents:14800,sales_assisted_above:false,checkout_available:true}];
