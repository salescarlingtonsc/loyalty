...
/* The owner fixture moved to tests/browser/fixtures/owner-workspace-stub.mjs in V451, so the
   appbar harness could reuse this exact tenant instead of forking a copy that would drift. */
