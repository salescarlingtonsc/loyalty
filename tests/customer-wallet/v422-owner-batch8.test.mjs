...
test('photo 6: Available and History are tabs, and History is not fetched until it is opened', () => {
  ...
  assert.match(rewards, /Available\$\{readyCountV397\+entitlementsV429\.length\+tierPerksClaimableV502\.length\?` \(\$\{readyCountV397\+entitlementsV429\.length\+tierPerksClaimableV502\.length\}\)`:''\}/,
...
test('nestly_v428 item 6: the Available panel says which part of the count the customer gets', () => {
  ...
  assert.match(rewards, /data-rewards-tab-v422="available">Available\$\{readyCountV397\+entitlementsV429\.length\+tierPerksClaimableV502\.length\?` \(\$\{readyCountV397\+entitlementsV429\.length\+tierPerksClaimableV502\.length\}\)`:''\}/);
});
