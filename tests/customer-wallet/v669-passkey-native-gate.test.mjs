...
test('both shell surfaces carry the honest native copy, not a browser-blame', () => {
  assert.match(appSource, /Face ID sign-in is coming to the app\. Use your password/);
  assert.match(appSource, /Face ID sign-in is coming to the Peekaa app\. Passkeys you add on peekaa\.asia/);
});
