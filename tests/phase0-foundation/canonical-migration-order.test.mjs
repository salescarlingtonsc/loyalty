...
test('materializer creates one byte-preserving 359-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v393_customer_tier_visibility' // tail
  );
