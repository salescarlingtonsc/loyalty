...
test('materializer creates one byte-preserving 426-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v551_top_share_denominator' // tail — top shares name their denominator
  );
