...
test('materializer creates one byte-preserving 338-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v377_no_credit_reward_types' // tail
  );
