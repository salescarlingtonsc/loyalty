...
test('materializer creates one byte-preserving 430-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v560_welcome_and_birthday_reach_customers' // tail — the promise on the business page exists where the customer can see it
  );
