...
test('materializer creates one byte-preserving 529-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v665_gift_staging_and_reversal' // tail — v665 a scanned perk lands in the sale and a wrong redemption can be taken back
