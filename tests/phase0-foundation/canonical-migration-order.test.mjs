...
test('materializer creates one byte-preserving 533-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v669_numeric_honesty' // tail — v669 numeric honesty (Newcombe hybrid Wilson CI + honest null median)
