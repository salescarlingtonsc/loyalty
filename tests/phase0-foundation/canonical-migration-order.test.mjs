...
test('materializer creates one byte-preserving 358-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v391_capabilities_undefined_column' // tail
  );
