...
test('materializer creates one byte-preserving 337-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v376_no_classic_redemption_offer' // tail
  );
