...
test('materializer creates one byte-preserving 449452 and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v612_referral_immediate_when_no_floor' // tail — the join sheet's referral code pays both sides, immediately when no floor
