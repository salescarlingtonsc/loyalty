...
test('materializer creates one byte-preserving 380-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v455_stock_follows_sale_items' // tail — v455: FEFO follows sale_items, so a bill with two products stops skipping stock
  );
