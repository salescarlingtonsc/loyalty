...
test('materializer creates one byte-preserving 389-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v478_earned_stamp_gifts_survive_a_claimed_card' // tail — v472: a gift end date the Point system page can set, and a separate menu gallery (owner batch 11)
  );
