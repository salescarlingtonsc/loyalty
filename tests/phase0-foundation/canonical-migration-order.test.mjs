...
test('materializer creates one byte-preserving 334-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v372_gift_follows_its_programme' // tail
  );
