...
test('materializer creates one byte-preserving 385-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v473_erasure_unlinks_the_customer' // tail — v472: a gift end date the Point system page can set, and a separate menu gallery (owner batch 11)
  );
