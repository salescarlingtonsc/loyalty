...
test('materializer creates one byte-preserving 422-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v545_programme_aware_loyalty_evidence' // tail — the AI evidence pack is programme-aware and unit-safe
  );
