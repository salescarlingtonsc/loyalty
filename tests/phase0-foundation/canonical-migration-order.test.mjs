...
test('materializer creates one byte-preserving 414-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v528_whatsapp_webhook_retention' // tail — customerintel resolves through entitlement
  );
