...
test('materializer creates one byte-preserving 428-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v556_policy_read_is_strict' // tail — the evidence layer reads the v10.1 policy snapshot strictly
  );
