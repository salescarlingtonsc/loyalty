...
test('materializer creates one byte-preserving 390-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v479_customer_wallet_realtime_signal' // tail — v472: a gift end date the Point system page can set, and a separate menu gallery (owner batch 11)
  );
