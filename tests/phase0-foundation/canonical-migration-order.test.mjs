...
test('materializer creates one byte-preserving 333-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v371_programme_off_reaches_customer' // tail
  );
