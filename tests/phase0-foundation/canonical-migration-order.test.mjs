...
test('materializer creates one byte-preserving 543-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v681_free_gift_confirm_at_scan' // tail — v681 a scanned gift that needs no purchase is confirmed yes/no at the keypad
