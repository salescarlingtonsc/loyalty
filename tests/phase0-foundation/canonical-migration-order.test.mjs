...
test('materializer creates one byte-preserving 448451 and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v598_shop_hours_are_the_default' // tail — the shop's opening hours are every teammate's default working hours
    // previously: nestly_v593_package_expiry // a prepaid package can be given a life
  );
