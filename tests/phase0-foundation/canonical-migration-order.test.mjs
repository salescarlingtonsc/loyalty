...
test('materializer creates one byte-preserving 372-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v421_two_sided_referral' // tail
  );
