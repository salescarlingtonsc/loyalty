...
test('materializer creates one byte-preserving 428-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v551_whatsapp_bringback_sends' // tail — bring-back vouchers reach the customer's phone
  );
