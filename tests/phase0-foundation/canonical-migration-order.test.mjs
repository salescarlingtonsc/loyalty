...
test('materializer creates one byte-preserving 416-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v531_support_inbound_router' // tail — customerintel resolves through entitlement
  );
