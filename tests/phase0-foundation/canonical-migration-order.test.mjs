...
test('materializer creates one byte-preserving 539-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v742_synthetic_excluded_estate_4' // tail — v742 synthetic excluded estate 4, after v741 roster read audit and v740 synthetic excluded estate 3
