...
test('materializer creates one byte-preserving 420-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v544_one_current_loyalty_balance' // tail — one canonical current loyalty balance
  );
