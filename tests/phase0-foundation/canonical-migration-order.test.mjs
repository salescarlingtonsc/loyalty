...
test('materializer creates one byte-preserving 382-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v463_stamp_card_max_length' // tail — v463: the longest stamp card a firm may set is 15, not 100
  );
