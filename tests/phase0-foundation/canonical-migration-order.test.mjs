...
test('materializer creates one byte-preserving 402-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v511_work_operating_system' // tail — reschedule replaces (owner photo 3)
  );
