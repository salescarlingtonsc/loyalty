...
test('materializer creates one byte-preserving 404-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v512_commercial_handoff_integrity' // tail — a stamps business can be corrected at all
  );
