...
test('materializer creates one byte-preserving 394-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v495_stopped_programme_gifts_not_offered' // tail — v488 product bundles + 7/3/0-day bottle checkpoints
  );
