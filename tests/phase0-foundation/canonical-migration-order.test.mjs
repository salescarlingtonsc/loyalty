...
test('materializer creates one byte-preserving 406-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v514_one_authority_for_on_means_live' // tail — on means live on both sides
  );
