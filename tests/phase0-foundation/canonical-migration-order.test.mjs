...
test('materializer creates one byte-preserving 351-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v380_promotion_breaker_bigint_overloads' // tail
  );
