...
test('materializer creates one byte-preserving 539-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v678_consultant_spine' // tail — v678 the consultant spine: ranked opportunities that cite their evidence
