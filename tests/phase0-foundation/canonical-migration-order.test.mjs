...
test('materializer creates one byte-preserving 388-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v477_per_gift_where_it_works' // tail — v472: a gift end date the Point system page can set, and a separate menu gallery (owner batch 11)
  );
