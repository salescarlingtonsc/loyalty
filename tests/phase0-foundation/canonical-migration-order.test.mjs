...
test('materializer creates one byte-preserving 373-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v432_staff_redeem_list_matches_customer' // tail — the 2026-08-22 rewards go-live wave
  );
