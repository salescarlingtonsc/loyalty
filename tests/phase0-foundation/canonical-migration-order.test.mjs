...
test('materializer creates one byte-preserving 382-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v462_featured_offer_and_live_cap' // tail — v462: every live offer on the business page, one featured on Home
  );
