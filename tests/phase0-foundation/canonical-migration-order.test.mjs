...
test('checked-in canonical plan preserves 45 trusted catalog versions then 467 unique pending versions', () => {
...
test('materializer creates one byte-preserving 518-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v650_ci_read_layer' // tail — Phase B/C wave: v644 can-contact authority, v645 messaging retention, v646 engagement rollups, v647 canonical taxonomy, v648 service canonical map, v649 category snapshot at sale, v650 CI read layer
