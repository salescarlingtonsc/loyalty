...
test('materializer creates one byte-preserving 361-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v403_stamp_conversion_ledger_token' // tail
  );
