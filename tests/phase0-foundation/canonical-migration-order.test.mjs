...
test('materializer creates one byte-preserving 397-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v504_whatsapp_webhook_inbox' // tail — v488 product bundles + 7/3/0-day bottle checkpoints
  );
