...
test('materializer creates one byte-preserving 382-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v464_earned_reward_expiry' // tail — v464: an earned stamp reward may be given a shelf life
  );
