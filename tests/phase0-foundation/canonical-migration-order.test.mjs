...
test('materializer creates one byte-preserving 444-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v575_waitlist_preferred_at' // tail — retention lane inert repair
  );
