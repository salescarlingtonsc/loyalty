...
test('materializer creates one byte-preserving 336-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v375_points_are_not_credit' // tail
  );
