...
test('materializer creates one byte-preserving 387-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v475_stamp_card_hides_switched_off_gifts' // tail — v472: a gift end date the Point system page can set, and a separate menu gallery (owner batch 11)
  );
