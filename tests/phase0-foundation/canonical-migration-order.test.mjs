...
test('materializer creates one byte-preserving 413-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v523_customer_intelligence_follows_entitlement' // tail — customerintel resolves through entitlement
  );
