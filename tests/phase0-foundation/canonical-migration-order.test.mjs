...
test('materializer creates one byte-preserving 520-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v652_evidence_contract' // tail — Phase D wave: v651 canonical cadence, v652 evidence contract
