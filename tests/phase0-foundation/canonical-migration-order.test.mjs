...
test('materializer creates one byte-preserving 443-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v574_retention_control_plane' // tail — retention lane inert repair
  );
