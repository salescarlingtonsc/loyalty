...
test('materializer creates one byte-preserving 391-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v488_product_bundles_and_bottle_checkpoints' // tail — v488 product bundles + 7/3/0-day bottle checkpoints
  );
