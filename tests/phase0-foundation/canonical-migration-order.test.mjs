...
test('materializer creates one byte-preserving 539-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v739_top_customers_floor' // tail — v739 top customers floor, after v738 pack report sections and v737 synthetic excluded v83 shadow
