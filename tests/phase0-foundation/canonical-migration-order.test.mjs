...
test('materializer creates one byte-preserving 448-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v581_appointment_branch_address' // tail — a booking row can say where it was
    // previously: nestly_v580_appointment_send_follows_the_appointment // a cancelled appointment sends nothing
  );
