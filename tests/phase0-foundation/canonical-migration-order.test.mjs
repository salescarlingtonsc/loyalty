...
test('materializer creates one byte-preserving 431-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v563_stamps_publish_needs_length' // tail — a live stamp card always knows its own length
  );
