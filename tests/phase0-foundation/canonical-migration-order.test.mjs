...
test('materializer creates one byte-preserving 448451 and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v593_package_expiry' // tail — a prepaid package can be given a life
    // previously: nestly_v589_referral_switch_is_one_switch // both referral doors move one switch
  );
