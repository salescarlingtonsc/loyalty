...
test('materializer creates one byte-preserving 407-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v513_onboarding_next_actor_and_review' // tail — on means live on both sides
  );
