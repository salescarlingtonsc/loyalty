...
test('materializer creates one byte-preserving 526-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v660_owner_rulings' // tail — v660 owner rulings
