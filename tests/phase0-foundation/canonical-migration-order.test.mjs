...
test('materializer creates one byte-preserving 363-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v409_canonical_points_balance' // tail
  );
