...
test('materializer creates one byte-preserving 435-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v568_survivor_arm_stays_in_its_pot' // tail — a survivor gift belongs to the card it survived
  );
