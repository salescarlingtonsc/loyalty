...
test('materializer creates one byte-preserving 539-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v730_category_customers_window' // tail — v730 category customers window, last of the v718/v720/v722/v724/v726/v729/v730 CI-D tail
