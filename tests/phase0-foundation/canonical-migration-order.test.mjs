...
test('materializer creates one byte-preserving 393-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v494_wallet_signal_visits_and_grants' // tail — v488 product bundles + 7/3/0-day bottle checkpoints
  );
