...
test('materializer creates one byte-preserving 371-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v420_referral_free_gift' // tail
  );
