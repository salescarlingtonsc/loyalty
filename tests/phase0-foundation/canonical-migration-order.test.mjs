...
test('materializer creates one byte-preserving 535-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v673_staff_insert_owner_only' // tail — v673 staff_insert is owner-only (audit F132)
