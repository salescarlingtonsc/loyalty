...
test('materializer creates one byte-preserving 403-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v512_adjust_follows_the_running_programme' // tail — a stamps business can be corrected at all
  );
