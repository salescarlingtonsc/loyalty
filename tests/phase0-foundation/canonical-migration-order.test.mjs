...
test('materializer creates one byte-preserving 548-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v686_service_delete_owner_only_rpc' // tail — v686 hard-deleting a service is owner-only at the RPC (audit F068; renumbered from v682 after a slot collision) — with v683 referral new-customers-only, v684 delete retired offer, v685 Singapore day authority
