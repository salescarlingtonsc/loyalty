...
test('materializer creates one byte-preserving 448451 and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v588_staff_signup_flow_integrity' // tail — the staff sign-up flow stops contradicting itself
    // previously: nestly_v587_join_qr_names_its_business // a scanned QR names its business and opens it
  );
