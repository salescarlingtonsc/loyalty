...
test('materializer creates one byte-preserving 448451 and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v589_referral_switch_is_one_switch' // tail — both referral doors move one switch
    // previously: nestly_v588_staff_signup_flow_integrity // the staff sign-up flow stops contradicting itself
  );
