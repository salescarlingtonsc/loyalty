...
test('materializer creates one byte-preserving 353-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v383_off_days_block_bookings' // tail
  );
