...
test('materializer creates one byte-preserving 542-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v680_manual_payment_reopens_workspace' // tail — v680 a verified manual payment reopens the workspace (audit F129)
