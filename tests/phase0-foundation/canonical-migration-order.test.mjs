...
test('materializer creates one byte-preserving 429-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v559_publish_never_flips_loyalty_off' // tail — publishing configures, the switchboard switches
  );
