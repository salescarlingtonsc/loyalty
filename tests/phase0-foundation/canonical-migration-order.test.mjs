...
test('materializer creates one byte-preserving 312-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(manifest.pendingCount, 270); // + v311 money kernel + v312 pot migration + v315 lead score repair + v316 taxonomy/match queue repair + v317 restored dependencies + v318 system-managed flag alignment + v313/v314 W6 increment 1 (reward programme identity + switchboard inversion) + v319/v320 W6 wave 1 (referral spine gate + the four referral leaks; gift authoring programme choice + the total_stock column)
  assert.equal(manifest.itemCount, 315); // + v311 money kernel + v312 pot migration + v315 lead score repair + v316 taxonomy/match queue repair + v317 restored dependencies + v318 system-managed flag alignment + v313/v314 W6 increment 1 (reward programme identity + switchboard inversion) + v319/v320 W6 wave 1 (referral spine gate + the four referral leaks; gift authoring programme choice + the total_stock column)
