...
test('materializer creates one byte-preserving 399-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v507_a_business_is_born_live' // tail — a business is live from birth (owner: publish = live)
  );
