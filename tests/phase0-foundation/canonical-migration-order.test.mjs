...
test('materializer creates one byte-preserving 504-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v627_package_product_branches_and_request_amend' // tail — packages and products can be limited to branches, and a pending request can be amended // tail — the two automation control-plane writers
