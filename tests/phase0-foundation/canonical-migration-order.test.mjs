...
test('materializer creates one byte-preserving 379-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v454_audit_log_detail_column' // tail — v454: audit_log.detail, not audit_log.meta (P0: End/Delete and package rename could never commit)
  );
