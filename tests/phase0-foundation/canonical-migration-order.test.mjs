...
test('materializer creates one byte-preserving 390-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v482_loyalty_fence_null_guard' // tail — v482 absence of this backend's lock is denied
  );
