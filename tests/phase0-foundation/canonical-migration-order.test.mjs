...
test('materializer creates one byte-preserving 381-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v460_business_kpi_pot_scope' // tail — v460: the dashboard's Points earned counts one pot, in one unit
  );
