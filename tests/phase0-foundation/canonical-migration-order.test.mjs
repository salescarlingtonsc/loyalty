...
test('materializer creates one byte-preserving 448451 and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v587_join_qr_names_its_business' // tail — a scanned QR names its business and opens it
    // previously: nestly_v586_tier_basis_reaches_the_draft // a basis change reaches the open draft
  );
