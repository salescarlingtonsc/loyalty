...
test('materializer creates one byte-preserving 410-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v517_whatsapp_foundations' // tail — the stamp QR asks the availability core
  );
