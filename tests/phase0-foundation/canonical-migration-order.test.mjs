...
test('materializer creates one byte-preserving 434-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v566_one_claimable_answer' // tail — the home screen and the counter give one answer
  );
