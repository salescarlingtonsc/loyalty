...
test('materializer creates one byte-preserving 445-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v577_publish_preserves_tier_identity' // tail — publish preserves tier identity
  );
