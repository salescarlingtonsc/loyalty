...
test('materializer creates one byte-preserving 396-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v501_customer_sees_tier_benefits' // tail — v488 product bundles + 7/3/0-day bottle checkpoints
  );
