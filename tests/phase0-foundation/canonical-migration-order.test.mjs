...
test('materializer creates one byte-preserving 382-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v468_programme_usage_counts' // tail — v468: the programme analytics count uses, not people (owner photo 4)
  );
