...
test('materializer creates one byte-preserving 364-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v410_promotion_finalize_overload_ambiguity' // tail
  );
