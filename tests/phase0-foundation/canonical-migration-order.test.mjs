...
test('materializer creates one byte-preserving 409-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v516_stamp_qr_asks_the_availability_core' // tail — the stamp QR asks the availability core
  );
