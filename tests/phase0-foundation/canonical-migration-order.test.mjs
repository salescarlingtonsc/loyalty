...
test('materializer creates one byte-preserving 534-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v672_public_support_desk' // tail — v672 the public support desk (/support -> the super-admin queue)
