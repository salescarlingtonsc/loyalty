...
test('materializer creates one byte-preserving 424-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v548_attention_list' // tail — the dashboard attention list (who to bring back today)
  );
