...
test('materializer creates one byte-preserving 423-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v548_insights_partition_scope' // tail — the insight partitions cover what the headline covers, or say they don't
  );
