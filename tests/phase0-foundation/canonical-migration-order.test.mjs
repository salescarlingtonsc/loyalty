...
test('materializer creates one byte-preserving 544-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v682_custom_perk_is_not_a_free_gift' // tail — v682 a written 'custom' perk is not a no-purchase gift (owner ruling)
