...
test('materializer creates one byte-preserving 525-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v659_edit_means_edit' // tail — v659 edit means edit
