...
test('materializer creates one byte-preserving 412-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v521_redemption_off_is_a_decision' // tail — redemption off is a decision, not an accident
  );
