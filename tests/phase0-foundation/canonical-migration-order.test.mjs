...
test('materializer creates one byte-preserving 360-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v394_tier_lifecycle_checkout' // tail
  );
