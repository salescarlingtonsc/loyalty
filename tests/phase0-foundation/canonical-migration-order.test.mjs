...
test('materializer creates one byte-preserving 524-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v657_discount_two_shapes' // tail — v657 discount two shapes
