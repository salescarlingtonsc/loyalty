...
test('materializer creates one byte-preserving 382-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v469_grant_sales_name_themselves' // tail — v468: the programme analytics count uses, not people (owner photo 4)
  );
