...
test('materializer creates one byte-preserving 419-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v542_pending_business_may_ask_to_pay_manually' // tail — customerintel resolves through entitlement
  );
