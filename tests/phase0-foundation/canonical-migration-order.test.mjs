...
test('materializer creates one byte-preserving 529-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v665_branch_subscription_choice' // tail — v665 every branch is charged unless switched off (twin-name with the gift-staging v665 below)
