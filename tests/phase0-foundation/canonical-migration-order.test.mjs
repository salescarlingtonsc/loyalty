...
test('materializer creates one byte-preserving 438-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v571_retention_dispatch_inert_repair' // tail — retention lane inert repair
  );
