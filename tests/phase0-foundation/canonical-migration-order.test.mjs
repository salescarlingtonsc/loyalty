...
test('materializer creates one byte-preserving 412-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v520_a_points_gift_can_expire' // tail — a points gift carries its own optional expiry
  );
