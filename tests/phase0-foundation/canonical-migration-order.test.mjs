...
test('materializer creates one byte-preserving 378-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v437_history_rows_keep_their_unit' // tail — the 2026-08-22 stamp lifecycle wave (v433–v437)
  );
