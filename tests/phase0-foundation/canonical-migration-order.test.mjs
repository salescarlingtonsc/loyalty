...
test('materializer creates one byte-preserving 528-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v663_customer_appointment_changes' // tail — v663 customer appointment changes; v661 was applied earlier at its real ledger timestamp
