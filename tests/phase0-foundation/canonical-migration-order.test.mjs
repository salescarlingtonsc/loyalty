...
test('materializer creates one byte-preserving 425-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v550_recovery_report' // tail — the recovered-revenue report
  );
