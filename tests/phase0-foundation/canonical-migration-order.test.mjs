...
test('materializer creates one byte-preserving 395-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v496_full_card_rolls_and_gifts_stack' // tail — v488 product bundles + 7/3/0-day bottle checkpoints
  );
