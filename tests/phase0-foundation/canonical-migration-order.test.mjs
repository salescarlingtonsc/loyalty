...
test('materializer creates one byte-preserving 365-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v412_promotion_delete_module_key' // tail
  );
