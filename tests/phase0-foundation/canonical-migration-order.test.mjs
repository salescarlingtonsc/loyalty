...
test('materializer creates one byte-preserving 530-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v666_gift_scan_opens_the_sale' // tail — v666 a gift QR scanned at the keypad opens the sale (twin-named with the branch-capacity v666 below, parallel-session collision, not a real conflict)
