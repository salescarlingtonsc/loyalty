...
test('materializer creates one byte-preserving 382-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v465_home_ready_count' // tail — v465: the Home card carries a server-counted ready-reward figure
  );
