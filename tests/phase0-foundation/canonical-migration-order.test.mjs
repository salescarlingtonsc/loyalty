...
test('materializer creates one byte-preserving 362-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v404_manual_reward_redemption' // tail
  );
