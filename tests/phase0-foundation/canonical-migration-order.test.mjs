...
test('materializer creates one byte-preserving 421-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v539_dispatch_url_secret_name' // tail — one canonical current loyalty balance
  );
