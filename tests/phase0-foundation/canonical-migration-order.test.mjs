...
test('materializer creates one byte-preserving 400-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v508_reschedule_is_a_fresh_request' // tail — reschedule replaces (owner photo 3)
  );
