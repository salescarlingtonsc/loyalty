...
test('materializer creates one byte-preserving 448451 and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v586_tier_basis_reaches_the_draft' // tail — a basis change now reaches the open draft
    // previously: nestly_v583_owner_automation_toggles // a booking row can say where it was
  );
