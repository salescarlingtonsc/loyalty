...
test('materializer creates one byte-preserving 390-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v480_loyalty_value_integrity_fence' // tail — v472: a gift end date the Point system page can set, and a separate menu gallery (owner batch 11)
  );
