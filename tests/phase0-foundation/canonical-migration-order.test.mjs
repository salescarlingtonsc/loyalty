...
test('materializer creates one byte-preserving 386-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v474_staff_reads_the_stamp_card' // tail — v472: a gift end date the Point system page can set, and a separate menu gallery (owner batch 11)
  );
