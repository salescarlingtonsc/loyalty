...
test('materializer creates one byte-preserving 352-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v381_balance_follows_live_programme' // tail
  );
