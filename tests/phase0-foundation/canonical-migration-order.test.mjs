...
test('materializer creates one byte-preserving 384-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v472a_profile_extras_menu' // tail — v472: a gift end date the Point system page can set, and a separate menu gallery (owner batch 11)
  );
