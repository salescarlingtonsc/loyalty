...
test('materializer creates one byte-preserving 539-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v743_synthetic_scanner' // tail — v743 estate-wide synthetic scanner, after v742 synthetic excluded estate 4
