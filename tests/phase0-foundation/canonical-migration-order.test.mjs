...
test('materializer creates one byte-preserving 436-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v569_login_active_only_when_approved' // tail — an unapproved login is not an active one
  );
