...
test('materializer creates one byte-preserving 369-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v418_business_gallery_and_links' // tail
  );
