...
test('materializer creates one byte-preserving 505-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v641_inbox_mark_all_read_through_the_guard' // tail — mark-all-read delegates to the per-event writer // tail — reconcile-failure visibility (P0 hardening) // tail — the two automation control-plane writers
