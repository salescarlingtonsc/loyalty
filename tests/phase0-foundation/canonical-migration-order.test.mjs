...
test('materializer creates one byte-preserving 332-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v370_tier_discount_at_checkout' // tail
  );
