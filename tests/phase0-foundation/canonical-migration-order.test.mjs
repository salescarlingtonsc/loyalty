...
test('materializer creates one byte-preserving 398-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v505_first_gift_before_go_live' // tail — the first gift can be saved before go-live (P0)
  );
