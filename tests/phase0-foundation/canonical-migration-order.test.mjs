...
test('materializer creates one byte-preserving 390-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v481_legacy_referral_credit_fail_closed' // tail — v481 inconsistent legacy credit cannot manufacture a clawback
  );
