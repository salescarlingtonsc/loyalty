...
test('materializer creates one byte-preserving 428-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v557_whatsapp_appointment_notifications' // tail — the appointment tells the customer's phone, once
  );
