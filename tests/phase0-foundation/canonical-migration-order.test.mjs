...
test('materializer creates one byte-preserving 367-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v416_stamp_cycle_config_pin' // tail
  );
