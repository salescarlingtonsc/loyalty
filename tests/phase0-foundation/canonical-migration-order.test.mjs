...
test('materializer creates one byte-preserving 392-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v489_stamp_card_auto_rollover' // tail — v488 product bundles + 7/3/0-day bottle checkpoints
  );
