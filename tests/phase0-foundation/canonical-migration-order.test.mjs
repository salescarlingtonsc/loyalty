...
test('materializer creates one byte-preserving 523-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v656_tier_discount_scope' // tail — v656 tier discount scope
