...
test('materializer creates one byte-preserving 357-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v386_dated_programme_usage' // tail
  );
