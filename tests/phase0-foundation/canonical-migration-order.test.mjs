...
test('materializer creates one byte-preserving 427-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v552_gated_evidence_isolation' // tail — gated sections fail alone and name themselves
  );
