...
test('materializer creates one byte-preserving 419-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v537_capability_module_gate_uses_effective_mode' // tail — customerintel resolves through entitlement
  );
