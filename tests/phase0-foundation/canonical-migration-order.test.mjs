...
test('materializer creates one byte-preserving 539-file chain and deterministic manifests', async (t) => {
  ...
  assert.equal(
    ...
    'nestly_v735_evidence_pack_extended' // tail — v735 evidence pack extended, after v734 synthetic excluded everywhere
