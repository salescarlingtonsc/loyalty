...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    ['20260824', 9],
    ['20260825', 15], // v496, v501, v504, v505 first gift, v507 born live, v508 reschedule replaces, v510/v511 ops-os, v512 adjust follows programme
