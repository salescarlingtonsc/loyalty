...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    ['20260920', 60],
    // v748 an earn row states its own expiry date + v752 the birthday gift becomes a structured
    // benefit share the 20260923 file-name day; their deploy versions keep them strictly ordered.
    ['20260923', 2],
  ]);
  assert.deepEqual(
