...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    ['20260824', 9],
    ['20260825', 5], // v496 card rollover + gift stacking, v501 the tier perk reaches the customer, v504 WhatsApp inbox, v505 the first gift before go-live, v507 born live
