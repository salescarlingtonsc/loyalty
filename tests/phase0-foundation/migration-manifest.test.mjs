...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    ['20261010', 17] /* + v883 firm billing schedule (20261010180000) */ /* + v882 booking past-start outcome, preferred_at expiry, bookable bundles (20261010170000) */ /* nestly_v865-v878 number-accuracy wave, slots 20261010010000-20261010140000 */,
  ]);
  assert.deepEqual(
