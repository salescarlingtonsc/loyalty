...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    ['20261007', 4] /* + v809 till card standing + expense note (000000) + v810 ACL + credit-note history (010000) + v811 self-serve activation always births the loyalty row (020000) + v813 wallet readers stay in their own pot scope (040000) */,
  ]);
  assert.deepEqual(
