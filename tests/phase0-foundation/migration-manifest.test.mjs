...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    ['20260920', 60],
    ['20260923', 2], // + v751 discount cap wording lands on the same source date as v748 (deploy versions
                     // …000000 and …010000 keep them strictly ordered; v751 sorts between v748 and v749)
  ]);
  assert.deepEqual(
