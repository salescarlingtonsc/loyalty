...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    // 20260828 is deliberately absent: this map counts file-name-day COLLISIONS, and v568 is the
    // only migration on its day (nestly_v568, the stamp survivor arm's pot predicate).
