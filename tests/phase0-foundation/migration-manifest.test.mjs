...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    ['20261003', 3] /* v768 Keep on a paid stopping branch (000000) + v772 the Owner brief readers (010000) + v775 the visit-rhythm window total (020000) — this session's v772, twin-named with main's 20261004 branch-copy v772 */,
  ]);
  assert.deepEqual(
