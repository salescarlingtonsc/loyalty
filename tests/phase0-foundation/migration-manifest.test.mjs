...
test('manifest covers every executable SQL file with raw-byte SHA-256 and a companion digest', async (t) => {
  ...
  const expectedCollisionCounts = new Map([
    ...
    ['20260824', 9],
    ['20260825', 15],
    ['20260826', 5], // v517 + v518 + v518a // v496, v501, v504, v505 first gift, v507 born live, v508 reschedule replaces, v510/v511 ops-os, v512 adjust follows programme // + v520 a points gift can carry its own optional expiry // + v521 redemption off is a decision, not an accident (plan item B/D completion)
