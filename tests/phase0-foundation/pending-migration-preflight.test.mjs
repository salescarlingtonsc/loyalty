...
const sqlTestByMigrationName = new Map([
  ...
  /* v775 adds one top-level key to a function nestly_v772 introduced, so the suite that proves
     it is v772's own corpus fixture — which carries the `current` assertion. Sharing a suite
     path is the established pattern here (v255/v255a/v255b, v317/v318, the v343-v362 wave);
     the uniqueness assertion below is on migration IDENTITY, not on the suite path. */
