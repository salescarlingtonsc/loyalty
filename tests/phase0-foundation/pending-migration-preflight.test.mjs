...
const sqlTestBySemanticVersion = new Map([
  ...
  ['v632', 'db/tests/v632_inbox_mark_all_read.sql']
]);
...
const sqlTestByMigrationName = new Map([
  ...
  ['nestly_v632_inbox_mark_all_read', 'db/tests/v632_inbox_mark_all_read.sql'],
