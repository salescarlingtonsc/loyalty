...
const sqlTestBySemanticVersion = new Map([
  ...
  /* v601: deactivates nine cron jobs whose feature is off, done, or delivers to nowhere.
     It has no behaviour of its own -- a minimal existence-assertion suite covers it. */
