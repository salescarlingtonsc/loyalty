...
test('platform console exposes the required namespaced routes', async () => {
  ...
  assert.deepEqual(
    ...
    ['Today','Pipeline','Onboarding','Prospecting','Firms','Reports','Marketing usage','Subscription operations','Cash P&L','Commission payable','Promo codes','Sector modules','System health','Partner obligations','Support requests','Platform access'] // operating-system IA pass: -4 merged routes
  );
});
