...
test('every mapped module and literal control passes the V123 readiness inventory',()=>{
  ...
  assert.equal(report.platform.expected,16); // + v961 Promo codes, a new Finance surface (a promo code changes what a firm is charged, so it is super-admin only and has no moduleKey) // operating-system IA pass 1: demo-requests, customer-lifecycle, billing and companies folded into onboarding / subscription-operations / firms (adjudicated ruling 2026-08-25)
